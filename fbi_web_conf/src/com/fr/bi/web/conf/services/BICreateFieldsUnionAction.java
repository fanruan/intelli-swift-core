...
public class BICreateFieldsUnionAction extends AbstractBIConfigureAction {
    ...
    private JSONObject createIDJSON(ICubeTableSource source, String idFieldName, String divideLength, boolean isFetchUnionLength, long userId) throws Exception{
    ...
    private JSONObject createIDPIDJSON(ICubeTableSource source, String idFieldName, String pidName, long userId) throws Exception{
        JSONObject jo = new JSONObject();
