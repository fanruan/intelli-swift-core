 ...
 */
public class BISetDeployModeLimitValueAction extends AbstractBIConfigureAction {
    @Override
    protected void actionCMDPrivilegePassed(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        try {
            ;
            PerformancePlugManager.getInstance().setDeployModeSelectSize(Integer.parseInt(size));
