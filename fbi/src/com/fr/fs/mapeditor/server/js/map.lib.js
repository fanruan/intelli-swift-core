 ...
 */
    ...
    L.drawLocal = {
        draw: {
            toolbar: {
                actions: {
                    title: FR.i18nText('BI-FS-Module_Map_Editor_CancelDrawing'),
                    text: FR.i18nText('BI-FS-Module_Map_Editor_Cancel')
                },
                undo: {
                    title: FR.i18nText('BI-FS-Module_Map_Editor_DeleteLast'),
                    text: FR.i18nText('BI-FS-Module_Map_Editor_DeleteLast')
                },
                buttons: {
                    polyline: FR.i18nText('BI-FS-Module_Map_Editor_DrawPolyline'),
                    polygon: FR.i18nText('BI-FS-Module_Map_Editor_DrawPolygon'),
                    rectangle: FR.i18nText('BI-FS-Module_Map_Editor_DrawRectangle'),
                    circle: FR.i18nText('BI-FS-Module_Map_Editor_DrawCircle'),
                    marker: FR.i18nText('BI-FS-Module_Map_Editor_DrawMarker')
                }
            },
            handlers: {
                circle: {
                    tooltip: {
                        start: FR.i18nText('BI-FS-Module_Map_Editor_HowtoDrawCircle')
                    }
                },
                marker: {
                    tooltip: {
                        start: FR.i18nText('BI-FS-Module_Map_Editor_HowtoDrawMarker')
                    }
                },
                polygon: {
                    tooltip: {
                        start: FR.i18nText('BI-FS-Module_Map_Editor_StartPolygon'),
                        cont: FR.i18nText('BI-FS-Module_Map_Editor_ContinuePolygon'),
                        end: FR.i18nText('BI-FS-Module_Map_Editor_FinishPolygon')
                    }
                },
                polyline: {
                    error: FR.i18nText('BI-FS-Module_Map_Editor_PolylineError'),
                    tooltip: {
                        start: FR.i18nText('BI-FS-Module_Map_Editor_StartPolyline'),
                        cont: FR.i18nText('BI-FS-Module_Map_Editor_ContinuePolyline'),
                        end: FR.i18nText('BI-FS-Module_Map_Editor_FinishPolyline')
                    }
                },
                rectangle: {
                    tooltip: {
                        start: FR.i18nText('BI-FS-Module_Map_Editor_HowtoDrawRectangle')
                    }
                },
                simpleshape: {
                    tooltip: {
                        end:FR.i18nText('BI-FS-Module_Map_Editor_SimpelShape')
                    }
                }
            }
        },
        edit: {
            toolbar: {
                actions: {
                    save: {
                        title: FR.i18nText('BI-FS-Module_Map_Editor_SaveChanges'),
                        text: FR.i18nText('BI-FS-Module_Map_Editor_Save')
                    },
                    cancel: {
                        title: FR.i18nText('BI-FS-Module_Map_Editor_CancelChanges'),
                        text: FR.i18nText('BI-FS-Module_Map_Editor_Cancel')
                    }
                },
                buttons: {
                    edit: FR.i18nText('BI-FS-Module_Map_Editor_EditLayers'),
                    editDisabled: FR.i18nText('BI-FS-Module_Map_Editor_NoLayers'),
                    remove: FR.i18nText('BI-FS-Module_Map_Editor_DeleteLayers'),
                    removeDisabled: FR.i18nText('BI-FS-Module_Map_Editor_RemoveDisable')
                }
            },
            handlers: {
                edit: {
                    tooltip: {
                        text: FR.i18nText('BI-FS-Module_Map_Editor_DragToEdit'),
                        subtext: FR.i18nText('BI-FS-Module_Map_Editor_ClickCancel')
                    }
                },
                remove: {
                    tooltip: {
                        text: FR.i18nText('BI-FS-Module_Map_Editor_ClickToRemove')
                    }
                }
            }
        }
    ...
    L.Draw.Marker = L.Draw.Feature.extend({
        ...
        _fireCreatedEvent: function () {
            ...
            if(window.MAP_EDITOR_CONTROL){
                MAP_EDITOR_CONTROL.addListTableItem({
                    name:'', lng:latlng.lng, lat:latlng.lat
                });
            }

            var marker = new L.Marker(latlng, { icon: this.options.icon });
