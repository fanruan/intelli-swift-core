...
public class ResourceHelper {
    ...
    private static String[] getLocaleFiles() {
        return new String[]{"com/fr/bi/stable/locale"};
    }
    ...
    private static StringBuffer ensureI18n(Locale locale) {
        ...
        for (String dir : localeDirs) {
            ...
            try {
                r = ResourceBundle.getBundle(dir, locale, Interbi.class.getClassLoader());
            } catch (Exception e) {
                try {
                    r = ResourceBundle.getBundle(dir, Locale.US, Interbi.class.getClassLoader());
        ...
        try {
            i18nJS = new StringBuffer()
                    .append(TemplateUtils.renderTemplate("/com/fr/web/core/js/i18n4properties.js", map));
        } catch (IOException e) {
            FRLogger.getLogger().error(e.getMessage(), e);
        }
        return i18nJS;
    ...
    public static String createDefaultJs(Locale locale) throws Exception {
        FileCacheKey jsCacheKey = new FileCacheKey(ResourceConstants.DEFAULT_JS, locale);
        ...
        if (js == null) {
            synchronized (ResourceHelper.class) {
                ...
                js = new StringBuffer().append(createI18NJs(locale)).toString();
    ...
    public static void geti18nJS(HttpServletRequest req, HttpServletResponse res) throws Exception {
