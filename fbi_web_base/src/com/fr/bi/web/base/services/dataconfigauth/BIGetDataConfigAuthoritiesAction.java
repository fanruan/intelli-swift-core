...
public class BIGetDataConfigAuthoritiesAction extends AbstractBIBaseAction {
    ...
    private JSONArray createJSON4Admin() throws Exception {
        ...
        JSONObject connections = BIConnectionManager.getInstance().createJSON();
        Iterator<String> connectionNames = connections.keys();
        while (connectionNames.hasNext()) {
            JSONObject childConnNode = new JSONObject();
            JSONObject childPackNode = new JSONObject();
            String name = connectionNames.next();
            JSONObject connection = connections.getJSONObject(name);
            ...
            childConnNode.put("text", connection.getString("name"));
            ...
            childPackNode.put("text", connection.getString("name"));
