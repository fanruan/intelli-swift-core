...
public class FEGetPartImportedExcelAction extends ActionNoSessionCMD {

	@Override
	public String getCMD() {
		return "fe_get_part_imported_excel";
	}
	...
	public void actionCMD(HttpServletRequest req, HttpServletResponse res ) throws Exception {
        ...
        System.out.println("--开始获取Excel中部分表格（50行）--生成相应的标签--");
        BIHandleExcel biHandleExcel = new BIHandleExcel();
        Tag tag = biHandleExcel.getPartExcel4Preview(excelFile, req, null);
