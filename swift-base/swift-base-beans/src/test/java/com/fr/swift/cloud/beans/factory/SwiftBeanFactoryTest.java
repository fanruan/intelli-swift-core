...
import com.fr.swift.cloud.beans.exception.SwiftBeanException;
import com.fr.swift.cloud.beans.factory.bean.IBean;
import com.fr.swift.cloud.beans.factory.bean.ITestWithoutBeanPrototype;
import com.fr.swift.cloud.beans.factory.bean.ITestWithoutBeanSingleton;
import com.fr.swift.cloud.beans.factory.bean.TestWithoutBeanPrototype;
import com.fr.swift.cloud.beans.factory.bean.TestWithoutBeanSingleton;
...
public class SwiftBeanFactoryTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        beanFactory.registerPackages("com.fr.swift.cloud.beans.factory.bean");
        beanFactory.init();
    }
    ...
    public void testGetBeanByClassSingleton() {
        ...
        try {
            ...
            assertEquals(swiftBeanException.getMessage(), "IBean 's beanNames size >= 2");
        }
        assertEquals(bean1, bean2);
    }
