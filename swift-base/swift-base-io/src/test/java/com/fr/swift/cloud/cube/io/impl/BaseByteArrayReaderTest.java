...
public class BaseByteArrayReaderTest {
    ...
    public void isReadable() {
        ...
        PowerMockito.when(dataReader.isReadable()).thenReturn(true);
        assertFalse(new BaseByteArrayReader(dataReader, posReader, lenReader).isReadable());

        PowerMockito.when(posReader.isReadable()).thenReturn(true);
        assertFalse(new BaseByteArrayReader(dataReader, posReader, lenReader).isReadable());

        PowerMockito.when(lenReader.isReadable()).thenReturn(true);
