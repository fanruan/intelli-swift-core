...
import com.fr.swift.cloud.cube.io.impl.fineio.connector.annotation.ConnectorBuilder;
import com.fr.swift.cloud.cube.io.impl.fineio.connector.annotation.PackConnectorBuilder;
import com.fr.swift.cloud.cube.io.impl.fineio.connector.builder.FineIOConnectorBuilder;
import com.fr.swift.cloud.cube.io.impl.fineio.connector.builder.PackageConnectorBuilder;
...
public class SwiftConnectorCreator {
    ...
    public static Connector create(FineIOConnectorConfig fineIOConnectorConfig) {
        ...
        try {
            ...
            switch (type) {
                case LZ4:
                    Class clazz = Class.forName("com.fr.swift.cloud.cube.io.impl.fineio.connector.Lz4Connector");
