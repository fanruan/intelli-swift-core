...
import com.fr.swift.bitmap.roaringbitmap.RunContainer;
 ...
 * Uses a ShortBuffer to store data, unlike com.fr.swift.bitmap.roaringbitmap.RunContainer. Otherwise similar.
 * <p>
 * <p>
...
public final class MappeableRunContainer extends MappeableContainer implements Cloneable {
    ...
    public MappeableContainer andNot(MappeableArrayContainer x) {
        ...
        if (card <= MappeableArrayContainer.DEFAULT_MAX_SIZE) {
            ...
            ac.cardinality = com.fr.swift.bitmap.roaringbitmap.Util.unsignedDifference(this.getShortIterator(),
