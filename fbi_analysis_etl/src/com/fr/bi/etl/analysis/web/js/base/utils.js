        ...
        return function (widget, previewModel, operatorType, type) {
            ...
            var ajaxObject =  {
                work : function (callBack) {
                    BI.Utils.buildData(previewModel.update(), widget.previewTable, callBack, BI.bind(widget.getFilterValue, widget));
                }
            };
            ...
            switch (type) {
                case ETLCst.PREVIEW.SELECT : {
                    ajaxObject = {
                        work: function (callBack) {
                            BI.Utils.buildData(previewModel.update4Preview(), widget.previewTable, callBack, BI.bind(widget.getFilterValue, widget))
                        }
                    }
