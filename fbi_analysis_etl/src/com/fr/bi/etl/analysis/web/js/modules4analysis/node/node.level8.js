...
BI.SelectDataLevel8Node = FR.extend(BI.NodeButton, {
    ...
    _init: function () {
        ...
        self.startChecker(this.options.id);
    },
    ...
    doRedMark: function () {
        this.text.doRedMark.apply(this.text,  this.getMarkArguments(this.options.id, this.options.text));
    },
