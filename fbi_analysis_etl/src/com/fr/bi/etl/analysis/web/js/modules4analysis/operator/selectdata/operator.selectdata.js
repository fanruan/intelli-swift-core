 ...
 */
BI.AnalysisSelectDataOperator = BI.inherit(BI.Widget, {
    ...
    render: function () {
        ...
        this.model = new BI.AnalysisSelectDataOperatorModel();
            ...
            items: [{
                el: {
                    ...
                    items: [{
                        ...
                        el: {
                            type: "bi.analysis_select_data_operator_pane",
                            ref: function (_ref) {
                                self.selectPane = _ref;
                            },
                            listeners: [{
                                eventName: BI.AnalysisSelectDataOperatorPane.EVENT_CLICK_ITEM,
                                action: function (v) {
    ...
    changeEditState: function () {
        ...
        if (this._editing === true) {
            var res = this.options.checkBeforeSave(this.model.getValue4Preview());
            if (res[0] === false) {
    ...
    _showMask: function () {
        BI.Layers.make(this.getName(), this.selectPane, {
            render: {
                cls: "disable"
            }
        });
    ...
    _populate: function () {
        this.center.populate(this.model.getValue(), BI.extend(this.options, {
            showContent: false
        }));
        this._refreshState();
    ...
    populate: function (table) {
        ...
        this._editing = this.model.getFields().length === 0;
        this.selectPane.populate(table);
        this._populate();
    },
...
BI.shortcut("bi.analysis_select_data_operator", BI.AnalysisSelectDataOperator);