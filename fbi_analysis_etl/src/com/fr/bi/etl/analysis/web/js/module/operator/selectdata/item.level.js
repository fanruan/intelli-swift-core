 ...
 */
BI.AnalysisETLDetailSelectDataLevelItem = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.AnalysisETLDetailSelectDataLevelItem.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.AnalysisETLDetailSelectDataLevelItem.superclass._init.apply(this, arguments);
    ...
    setEnable : function (v) {
        BI.AnalysisETLDetailSelectDataLevelItem.superclass.setEnable.apply(this, arguments)
...
BI.shortcut("bi.analysis_etl_detail_select_data_level_item", BI.AnalysisETLDetailSelectDataLevelItem);