BI.NumericalIntervalMoreCombo = BI.inherit(BI.Widget, {
    constants: {
        expandClass: "combo-expand",
        tgap: 2
    },
    _defaultConfig: function () {
        var conf = BI.NumericalIntervalMoreCombo.superclass._defaultConfig.apply(this, arguments);
        return BI.extend(conf, {
            ...
            items: [{
                ...
                text: "≥(" + BI.i18nText("More_Than_And_Equal") + ")",
                value: 1
            }],
            height:30,
            adjustLength: -1,
    ...
    _init: function () {
        ...
        BI.NumericalIntervalMoreCombo.superclass._init.apply(this, arguments);
        ...
        this.trigger = BI.createWidget({
            type: "bi.numerical_more_interval_trigger",
            height: o.height-2,
            value: o.value
        })
...
$.shortcut("bi.numerical_interval_more_combo", BI.NumericalIntervalMoreCombo);