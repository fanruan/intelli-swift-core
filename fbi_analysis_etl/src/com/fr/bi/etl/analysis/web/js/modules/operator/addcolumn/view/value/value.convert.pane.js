                    ...
                    items : [
                        {
                            ...
                            cls : 'label-name',
                            width : self._constants.LABEL_WIDTH,
                            text : BI.i18nText('BI-Base_Type') + BI.i18nText('BI-Basic_Choose'),
                            textAlign : 'left'
                        },
                        {
                            el : self.segment
...
$.shortcut(ETLCst.ANALYSIS_ETL_PAGES.ADD_COLUMN + '_' + BICst.ETL_ADD_COLUMN_TYPE.VALUE_CONVERT, BI.AnalysisETLOperatorAddColumnValueConvertPane);