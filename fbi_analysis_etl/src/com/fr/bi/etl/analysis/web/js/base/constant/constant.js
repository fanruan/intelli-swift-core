...
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BICst.ETL_ADD_COLUMN_TYPE.FORMULA] = [BICst.COLUMN.NUMBER, BICst.COLUMN.STRING, BICst.COLUMN.DATE];
...
ETLCst.ANALYSIS_OPERATORS = [{
    text: BI.i18nText("BI-Choose_Field"),
    value: ETLCst.ETL_TYPE.SELECT_DATA,
    operatorType: "bi.analysis_select_data_operator"
}, {
    text: BI.i18nText("BI-Choose_Field"),
    value: ETLCst.ETL_TYPE.SELECT_NONE_DATA,
    operatorType: ETLCst.ANALYSIS_ETL_PAGES.SELECT_NONE_DATA
