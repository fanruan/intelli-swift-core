...
ETLCst.ANALYSIS_ADD_COLUMN_TYPE = [[{
    ...
    value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.FORMULA
}],[{
    el:{
    ...
    children:[{
        ...
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_DIFF
    },{
        text:BI.i18nText("BI-Date_Year"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_YEAR
    },{
        text:BI.i18nText("BI-Date_Season"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_SEASON
    },{
        text:BI.i18nText("BI-Date_Month"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_MONTH
    }]
}],[{
    el:{
    ...
    children:[{
        ...
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_CPP
    },{
        text:BI.i18nText("BI-Month_On_Month_Value"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_LP
    },{
        text:BI.i18nText("BI-Year_On_Year_Rate"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_CPP_PERCENT
    },{
        text:BI.i18nText("BI-Month_On_Month_Rate"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_LP_PERCENT
    },{
        text:BI.i18nText("BI-All_Values") +"/" + BI.i18nText("BI-All_Values_In_Group"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_SUM
    },{
        text:BI.i18nText("BI-Cumulative_Value") +"/" + BI.i18nText("BI-Cumulative_Value_In_Group"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_ACC
    },{
        text:BI.i18nText("BI-Ranging") +"/" + BI.i18nText("BI-Group_Ranking"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_RANK
    }]
}],[{
    el:{
    ...
    children:[{
        ...
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.GROUP
    },{
        text:BI.i18nText("BI-Setted_Value"),
        value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.SINGLE_VALUE
    }]
}], [{
    text:BI.i18nText("BI-Convert"),
    value:BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.VALUE_CONVERT
}]]
...
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.FORMULA] = [BICst.COLUMN.STRING, BICst.COLUMN.NUMBER, BICst.COLUMN.DATE];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_DIFF] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_YEAR] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_SEASON] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.DATE_MONTH] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_CPP] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_LP] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_CPP_PERCENT] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_LP_PERCENT] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_SUM] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_ACC] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.EXPR_RANK] = [BICst.COLUMN.NUMBER];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.GROUP] = [BICst.COLUMN.STRING, BICst.COLUMN.NUMBER, BICst.COLUMN.DATE];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.SINGLE_VALUE] = [BICst.COLUMN.STRING, BICst.COLUMN.NUMBER, BICst.COLUMN.DATE];
ETLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[BI.ANALYSIS_ETL_ADD_COLUMN_TYPE.VALUE_CONVERT] = [BICst.COLUMN.STRING, BICst.COLUMN.NUMBER, BICst.COLUMN.DATE];
