...
ETLCst.ANALYSIS_ADD_COLUMN_TYPE = [[{
    ...
    children:[{
        ...
        text:BI.i18nText("BI-Base_Ranging") +"/" + BI.i18nText("BI-Group_Ranking"),
...
ETLCst.ANALYSIS_ADD_COLUMN_EXPR_RANK_TYPE_ITEMS = [{
    ...
    text: BI.i18nText("BI-Asc_Group")+ BI.i18nText('BI-Base_Ranging'),
    ...
    text: BI.i18nText("BI-Des_Group") + BI.i18nText('BI-Base_Ranging'),
