 ...
 */
package com.fr.swift.jdbc.druid.sql.dialect.postgresql.visitor;
...
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.*;
...
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGBoxExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGCidrExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGCircleExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGExtractExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGInetExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGLineSegmentsExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGMacAddrExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGPointExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGPolygonExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.expr.PGTypeCastExpr;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.stmt.*;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.stmt.PGSelectQueryBlock.FetchClause;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.stmt.PGSelectQueryBlock.ForClause;
import com.fr.swift.jdbc.druid.sql.dialect.postgresql.ast.stmt.PGSelectQueryBlock.WindowClause;
