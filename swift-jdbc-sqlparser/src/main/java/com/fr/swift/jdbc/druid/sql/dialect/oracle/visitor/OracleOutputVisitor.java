 ...
 */
package com.fr.swift.jdbc.druid.sql.dialect.oracle.visitor;
...
import com.fr.swift.jdbc.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.CycleClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.OracleStorageClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.SampleClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.clause.SearchClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.expr.*;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.*;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.parser.OracleFunctionDataType;
import com.fr.swift.jdbc.druid.sql.dialect.oracle.parser.OracleProcedureDataType;
...
//    }
    ...
    @Override
    public void endVisit(com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.fr.swift.jdbc.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
