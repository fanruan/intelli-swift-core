...
public class CollateExecutorTask extends AbstractExecutorTask<Job> {
    ...
    public CollateExecutorTask(SourceKey sourceKey, Job job) {
        super(sourceKey, false, ExecutorTaskType.COLLATE, LockType.TABLE, sourceKey.getId(), DBStatusType.ACTIVE, job);
    }
}
