...
import com.finebi.cube.tools.BIBusinessPackageTestTool;
...
public class SystemPackageTest extends TestCase {
    ...
    public void testAddGroup() {
        try {
            manager = new BISystemPackageConfigurationManagerNoInit();
    ...
    public void testGetAllPackage() {
        try {
            ...
            manager.addPackage(user.getUserId(), BIBusinessPackageTestTool.generatePackage("ab"));
            manager.addPackage(user.getUserId(), BIBusinessPackageTestTool.generatePackage("abc"));
            Set<IBusinessPackageGetterService> allPackages = manager.getAllPackages(user.getUserId());
            ...
            Set<IBusinessPackageGetterService> allPackages2 = manager.getAllPackages(user.getUserId());
    ...
    public void testStickGroupTagOnPackage() {
        try {
            ...
            IBusinessGroupGetterService group = manager.getGroup(user.getUserId(), new BIGroupTagName("a"));
    ...
    * */
    ...
    public void testWriteXMLParallel() {
        try {
            ...
            BIBasicBusinessPackage biBasicBusinessPackage = BIBusinessPackageTestTool.generatePackage("a");
            manager.addPackage(user.getUserId(), biBasicBusinessPackage);
    ...
    private class BISystemPackageConfigurationManagerNoInit extends BISystemPackageConfigurationManager {
        @Override
        public BIUserPackageConfigurationManager constructValue(Long userId) {
            BIUserPackageConfigurationManager manager = constructUserManagerValue(userId);
            return manager;
        }
    }
}