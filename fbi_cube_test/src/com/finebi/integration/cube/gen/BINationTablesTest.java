...
public class BINationTablesTest extends BICubeTestBase {
    ...
    public void testFieldPathIndex() {
        try {
            ...
            assertTrue(iCubeRelationEntityGetterService.getBitmapIndex(0).hasSameValue(RoaringGroupValueIndex.createGroupValueIndex(new int[]{0})));
            assertTrue(iCubeRelationEntityGetterService.getNULLIndex(0).hasSameValue(RoaringGroupValueIndex.createGroupValueIndex(new int[]{}))
                    || iCubeRelationEntityGetterService.getNULLIndex(0).equals(RoaringGroupValueIndex.createGroupValueIndex(new int[]{})));
            ...
            //获取本表对应位置索引值
            assertTrue(iCubeColumnReaderService.getIndexByGroupValue("nameA").hasSameValue(RoaringGroupValueIndex.createGroupValueIndex(new int[]{0, 2})));
            //根据行号(rowId来查询value
