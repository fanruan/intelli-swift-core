...
public class SortedDetailMergerIteratorTest extends TestCase {
    ...
    public void test() {
        ...
        List<DetailResultSet> resultSets = Arrays.asList(resultSet1, resultSet2, resultSet3);
        ...
        assertEquals((Integer) 1, rows.get(0).getValue(0));
        assertEquals((Integer) 2, rows.get(1).getValue(0));
        ...
        assertTrue(iterator.hasNext());
        rows = iterator.next();
        assertEquals((Integer) 2, rows.get(0).getValue(0));
        assertEquals((Integer) 2, rows.get(1).getValue(0));
        assertEquals(resultSet1.cursor, 2);
        ...
        assertTrue(iterator.hasNext());
        rows = iterator.next();
        assertEquals((Integer) 3, rows.get(0).getValue(0));
        assertEquals((Integer) 3, rows.get(1).getValue(0));
        assertEquals(resultSet1.cursor, 2);
        assertEquals(resultSet2.cursor, 4);
        assertEquals(resultSet3.cursor, 2);
        ...
        rows = iterator.next();
        assertEquals((Integer) 3, rows.get(0).getValue(0));
        assertEquals((Integer) 5, rows.get(1).getValue(0));
        ...
        assertTrue(iterator.hasNext());
        rows = iterator.next();
        assertEquals((Integer) 5, rows.get(0).getValue(0));
        assertEquals((Integer) 5, rows.get(1).getValue(0));
        assertEquals(resultSet1.cursor, 4);
        assertEquals(resultSet2.cursor, 4);
        assertEquals(resultSet3.cursor, 2);
        ...
        assertTrue(iterator.hasNext());
        rows = iterator.next();
        assertEquals((Integer) 6, rows.get(0).getValue(0));
        assertEquals((Integer) 6, rows.get(1).getValue(0));
        assertEquals(resultSet1.cursor, 4);
        assertEquals(resultSet2.cursor, 4);
