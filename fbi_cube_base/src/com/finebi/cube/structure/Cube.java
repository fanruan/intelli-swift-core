 ...
 *
 * @author Connery
 * @see com.finebi.cube.structure 包中是对结构的实现
...
public interface Cube extends ICubeVersion {
    ...
    CubeTableEntityService getCubeTableWriter(ITableKey tableKey);
     ...
     * @return 列的操作对象
     */
    CubeColumnReaderService getCubeColumn(ITableKey tableKey, BIColumnKey field) throws BICubeColumnAbsentException;
     ...
     * @return 关联路径的操作对象
     */
    CubeRelationEntityGetterService getCubeRelation(ITableKey tableKey, BICubeTablePath relationPath) throws BICubeRelationAbsentException, BICubeColumnAbsentException, IllegalRelationPathException;
