...
public final class BIColumnKey implements BIKey {
    ...
    private BIColumnKey(CubeFieldSource field) {
    ...
    public static List<BIColumnKey> generateColumnKey(CubeFieldSource field) {
    ...
    public static BIColumnKey covertColumnKey(CubeFieldSource field) {
        return new BIColumnKey(field);
    }

    public static List<BIColumnKey> generateSubField(CubeFieldSource field) {
    ...
    private static List<BIColumnKey> generateDateSubField(CubeFieldSource field) {
