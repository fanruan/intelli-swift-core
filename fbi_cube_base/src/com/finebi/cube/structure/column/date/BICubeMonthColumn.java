...
public class BICubeMonthColumn extends BICubeDateSubColumn<Integer> {
    ...
    protected Integer convertDate(Long date) {
        ...
        if(BICollectionUtils.isCubeNullKey(date)){
            ...
            return (Integer) ValueConverterFactory.createDateValueConverter(DateConstant.DATE.MONTH).result2Value(date);
        }
    ...
    protected Integer convertDate(Long date, Calendar calendar) {
        ...
        if(BICollectionUtils.isCubeNullKey(date)){
            ...
            return (Integer) ValueConverterFactory.createDateValueConverter(DateConstant.DATE.MONTH).result2Value(date, calendar);
        }
    }
