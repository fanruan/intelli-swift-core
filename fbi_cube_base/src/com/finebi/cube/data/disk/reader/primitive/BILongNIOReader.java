...
public class BILongNIOReader extends BIBasicNIOReader implements ICubeLongReader {
    ...
    public long getSpecificValue(long filePosition) throws BIResourceInvalidException {
        try {
            ...
            throw new RuntimeException("the expect position value is: " + getIndex(filePosition) + " and the current capacity  value is: " + longBufferArray[getPage(filePosition)].capacity() + " and the pageIndex is :" + getPage(filePosition) + e, e);
        } finally {
        }
