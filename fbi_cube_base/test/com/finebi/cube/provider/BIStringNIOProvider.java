 ...
 */
public class BIStringNIOProvider {

    public static BIStringNIOWriter BIStringNIOWriterProvider(String start, String length, String content) {
        ...
        return new BIStringNIOWriter(new BIByteArrayNIOWriter(startPositionRecorder, lengthRecorder, contentRecorder));
    }

    public static BIStringNIOReader BIStringNIOReaderProvider(String start, String length, String content) {
        ...
        return new BIStringNIOReader(new BIByteArrayNIOReader(startPositionRecorderReader, lengthRecorderReader, contentRecorderReader));
    }
}
