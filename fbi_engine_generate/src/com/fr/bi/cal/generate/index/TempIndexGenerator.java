...
public class TempIndexGenerator extends IndexGenerator {
    ...
    public TempIndexGenerator(ITableSource source, long userId) {
        super(source, userId, 0);
    }

    @Override
    protected void createTableCube() {
        this.cube = new TableCubeFile(BIBaseConstant.CACHE.getCacheDirectory() + BIPathUtils.tablePath(source.fetchObjectCore().getID().getIdentityValue()));
    }
}