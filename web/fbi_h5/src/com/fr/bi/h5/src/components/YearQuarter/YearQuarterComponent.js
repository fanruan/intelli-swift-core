...
import {YearQuarterWidget} from 'widgets'


class YearQuarterComponent extends Component {
    ...
    render() {
        ...
        return <YearQuarterWidget style={styles.wrapper}
                                year={widget.getYear()}
                                quarter={widget.getQuarter()}
                                onValueChange={(value)=> {
