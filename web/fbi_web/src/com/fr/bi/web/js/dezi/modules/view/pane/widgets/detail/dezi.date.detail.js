/**
 * @class BIDezi.DateDetailView
 * @extends BI.View
 *
 */
BIDezi.DateDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.DateDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.DateDetailView.superclass._init.apply(this, arguments);
    },
            ...
            dimensionCreator: function (dId, regionType, op) {
                ...
                function createSubVessel(dimensionId){
                    if (!dimensionsVessel[dimensionId]) {
                        ...
                        self.addSubVessel(dimensionId, dimensionsVessel[dimensionId]).skipTo(regionType + "/" + dimensionId, dimensionId, "dimensions." + dimensionId);
                    }
                }
            }
        });
    ...
    _createCombo: function () {
        ...
        this.combo.on(BI.CustomMultiDateCombo.EVENT_CHANGE, function () {
