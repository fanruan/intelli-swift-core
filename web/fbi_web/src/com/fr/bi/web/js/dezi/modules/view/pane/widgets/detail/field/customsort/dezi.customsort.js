 ...
 */
BIDezi.CustomSortView = BI.inherit(BI.BarFloatSection, {
    _defaultConfig: function () {
        return BI.extend(BIDezi.CustomSortView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-custom-sort-view"
        })
    },
    _init: function () {
        BIDezi.CustomSortView.superclass._init.apply(this, arguments);
    },
