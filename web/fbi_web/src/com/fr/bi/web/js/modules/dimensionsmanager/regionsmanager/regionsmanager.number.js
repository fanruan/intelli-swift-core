 ...
 * @class BI.NumberRegionsManager
 * @extends BI.RegionsManager
 */
BI.NumberRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.NumberRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-number-regions-manager",
    ...
    _init: function () {
        BI.NumberRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.number_regions_manager', BI.NumberRegionsManager);