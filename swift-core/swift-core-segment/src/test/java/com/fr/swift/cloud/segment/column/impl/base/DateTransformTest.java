...
import com.fr.swift.cloud.segment.column.impl.DateType;
import com.fr.swift.cloud.segment.column.impl.MixDateType;
...
public class DateTransformTest {
    ...
    public void testTransform() {
        ...
        Assert.assertEquals(year, DateType.YEAR.from(c));
        ...
        Assert.assertEquals(c.getTimeInMillis(), MixDateType.Y_M_D_H_M_S.from(c1));
