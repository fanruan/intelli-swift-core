package com.fr.swift.cloud.basics.annotation;
...
public @interface InvokeMethod {
    ...
    com.fr.swift.cloud.basics.annotation.Target[] target() default com.fr.swift.cloud.basics.annotation.Target.ALL;
}