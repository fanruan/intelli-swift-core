...
import com.fr.swift.cloud.db.AlreadyExistsException;
import com.fr.swift.cloud.db.AlterTableAction;
import com.fr.swift.cloud.db.Database;
import com.fr.swift.cloud.db.NoSuchTableException;
...
public class SwiftDatabase implements Database, Serializable {
    ...
    @Override
    public List<Table> getTablesBySchema(com.fr.swift.cloud.db.SwiftDatabase schema) {
