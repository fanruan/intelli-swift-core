 ...
 * <pre>
 * <code>
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.Histogram} histogram = new {@link com.fr.swift.cloud.query.aggregator.extension.histogram.Histogram}(3600000000L, 3);
 * .
 * .
 * .
 * // Repeatedly record measured latencies:
 * histogram.{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordValue(long) recordValue}(latency);
 * .
 * .
 * .
 * // Report histogram percentiles, expressed in msec units:
 * histogram.{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#outputPercentileDistribution(java.io.PrintStream, Double) outputPercentileDistribution}(histogramLog, 1000.0)};
 * </code>
 * </pre>
 ...
 * The HdrHistogram package includes multiple implementations of the {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram} class:
 * <ul>
 * <li> {@link com.fr.swift.cloud.query.aggregator.extension.histogram.Histogram}, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.IntCountsHistogram} , which track value counts
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used {@link com.fr.swift.cloud.query.aggregator.extension.histogram.Histogram}
 * class and it's {@link com.fr.swift.cloud.query.aggregator.extension.histogram.IntCountsHistogram} and
 ...
 * synchronize and/or order their access, or use the variants.
 * <p>
 ...
 * reporting operations are needed, consider using the  variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide {@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#percentiles percentiles} :
 * An {@link java.lang.Iterable}{@literal <}{@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}{@literal >} through the
 * histogram using a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.PercentileIterator} </li>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 * An {@link java.lang.Iterable}{@literal <}{@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}{@literal >} through
 * the histogram using a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.LinearIterator} </li>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 * An {@link java.lang.Iterable}{@literal <}{@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}{@literal >}
 * through the histogram using a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.LogarithmicIterator} </li>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordedValues recordedValues} :
 * An {@link java.lang.Iterable}{@literal <}{@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}{@literal >} through
 * the histogram using a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.RecordedValuesIterator} </li>
 * <li>{@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#allValues allValues} :
 * An {@link java.lang.Iterable}{@literal <}{@link com.fr.swift.cloud.query.aggregator.extension.histogram.HistogramIterationValue}{@literal >} through
 * the histogram using a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * iteration is provided with {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleHistogramIterationValue} and related iterator classes (
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleLinearIterator}, {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleLogarithmicIterator},
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoublePercentileIterator}, {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleRecordedValuesIterator},
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleAllValuesIterator}).
 ...
 * com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleHistogram} (and variants) is not specified upfront. Only the dynamic range of values
 * that the histogram can cover is (optionally) specified. E.g. When a {@link com.fr.swift.cloud.query.aggregator.extension.histogram.DoubleHistogram}
 ...
 * {@link com.fr.swift.cloud.query.aggregator.extension.histogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */

package com.fr.swift.cloud.query.aggregator.extension.histogram;
