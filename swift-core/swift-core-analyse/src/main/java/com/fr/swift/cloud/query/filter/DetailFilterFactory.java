...
import com.fr.swift.cloud.query.filter.detail.impl.EmptyDetailFilter;
import com.fr.swift.cloud.query.filter.detail.impl.InFilter;
import com.fr.swift.cloud.query.filter.detail.impl.NullFilter;
import com.fr.swift.cloud.query.filter.detail.impl.date.WorkDayFilter;
import com.fr.swift.cloud.query.filter.detail.impl.nfilter.BottomNFilter;
import com.fr.swift.cloud.query.filter.detail.impl.nfilter.TopNFilter;
import com.fr.swift.cloud.query.filter.detail.impl.number.NumberAverageFilter;
import com.fr.swift.cloud.query.filter.detail.impl.number.NumberInRangeFilter;
import com.fr.swift.cloud.query.filter.detail.impl.number.NumberStartsWithFilter;
import com.fr.swift.cloud.query.filter.detail.impl.string.StringEndsWithFilter;
import com.fr.swift.cloud.query.filter.detail.impl.string.StringKeyWordFilter;
import com.fr.swift.cloud.query.filter.detail.impl.string.StringLikeFilter;
import com.fr.swift.cloud.query.filter.detail.impl.string.StringLikeIgnoreCaseFilter;
import com.fr.swift.cloud.query.filter.detail.impl.string.StringStartsWithFilter;
...
import com.fr.swift.cloud.util.ReflectUtils;
...
public class DetailFilterFactory {
    ...
    public static DetailFilter createFilter(Segment segment, SwiftDetailFilterInfo filterInfo) {
        ...
        switch (filterInfo.getType()) {
            ...
            case FORMULA:
                final String className = "com.fr.swift.cloud.query.filter.FormulaFilter";
