package com.fr.swift.cloud.cube;
...
public class CubePathBuilderTest {
    ...
    public void testWrongBuild1() {
        new CubePathBuilder().setSwiftSchema(SwiftDatabase.CUBE).setTempDir(String.valueOf(1)).asBackup().build();
    }
