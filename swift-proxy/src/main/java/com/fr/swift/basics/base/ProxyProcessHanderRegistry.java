...
import com.fr.swift.basics.ProcessHanderRegistry;
 ...
 */
public class ProxyProcessHanderRegistry implements ProcessHanderRegistry {
    ...
    public static final ProcessHanderRegistry INSTANCE = new ProxyProcessHanderRegistry();
