...
public class HistoryBlockImporterTest {
    ...
    public void handleFullSegment() throws Exception {
        ...
        HistoryBlockImporter<SwiftSourceAlloter<?, RowInfo>> historyBlockImporter = PowerMockito.spy(new HistoryBlockImporter<SwiftSourceAlloter<?, RowInfo>>(mock(DataSource.class), mock(SwiftSourceAlloter.class)));
