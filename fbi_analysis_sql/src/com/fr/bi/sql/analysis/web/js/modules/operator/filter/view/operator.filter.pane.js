BI.AnalysisETLOperatorFilterPane = FR.extend(BI.MVCWidget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AnalysisETLOperatorFilterPane.superclass._defaultConfig.apply(this, arguments), {
            ...
            value:SQLCst.ANALYSIS_TABLE_HISTORY_TABLE_MAP.FILTER,
            model:{
    ...
    _initView: function () {
        ...
        this.content = BI.createWidget({
            type:SQLCst.ANALYSIS_ETL_PAGES.FILTER + "_table"
        })
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.FILTER + SQLCst.ANALYSIS_TABLE_PANE, BI.AnalysisETLOperatorFilterPane);