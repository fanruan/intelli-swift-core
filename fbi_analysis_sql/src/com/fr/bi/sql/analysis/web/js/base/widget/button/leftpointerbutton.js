/**
 * @class BI.SQLLeftPointerButton
 * @extends BI.BasicButton
 * 图标的button
 */
BI.SQLLeftPointerButton = FR.extend(BI.BasicButton, {

    _defaultConfig: function () {
        var conf = BI.SQLLeftPointerButton.superclass._defaultConfig.apply(this, arguments);
    ...
    _init: function () {
        this._switchOptions();
        BI.SQLLeftPointerButton.superclass._init.apply(this, arguments);
        var o = this.options;
        BI.createWidget({
            type:"bi.absolute",
...
$.shortcut("bi.left_pointer_button_sql", BI.SQLLeftPointerButton);