BI.MergeHistoryController = BI.inherit(BI.MVCController,  {
    ...
    showContentAndPreview : function (id, widget, model) {
        ...
        var name = item.text;
        var paneType = item.operatorType + SQLCst.ANALYSIS_TABLE_PANE
    ...
    _refreshPopData : function (widget, model){
        this.trigger(widget.previewTable, model, SQLCst.ANALYSIS_TABLE_OPERATOR_KEY.NULL, SQLCst.PREVIEW.MERGE)
    }
