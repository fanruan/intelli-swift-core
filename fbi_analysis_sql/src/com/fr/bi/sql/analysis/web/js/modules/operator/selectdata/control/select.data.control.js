BI.AnalysisETLOperatorSelectDataController = BI.inherit(BI.MVCController, {
    ...
    _construct : function(widget, model) {
        ...
        this._editing = model.get(SQLCst.FIELDS).length === 0;
    ...
    refreshPopData : function (operatorType, widget, model){
        this.trigger(widget.center, model, operatorType, SQLCst.PREVIEW.SELECT)
    },
    ...
    _refreshState : function (widget, model) {
        ...
        this.refreshPopData(this._editing ? SQLCst.ANALYSIS_ETL_PAGES.SELECT_DATA : SQLCst.ANALYSIS_TABLE_OPERATOR_KEY.NULL, widget, model);
