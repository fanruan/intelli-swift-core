BI.AnalysisETLOperatorAddColumnPaneTitle = FR.extend(BI.MVCWidget, {
    ...
    _initView: function () {
        ...
        this.typeCombo = BI.createWidget({
            ...
            cls:"add-column-type",
            items:SQLCst.ANALYSIS_ADD_COLUMN_TYPE,
            width: 200,
            height: 30
        })
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.ADD_COLUMN + SQLCst.ANALYSIS_TABLE_PANE + SQLCst.ANALYSIS_TABLE_TITLE, BI.AnalysisETLOperatorAddColumnPaneTitle);