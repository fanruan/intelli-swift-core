BI.AnalysisETLOperatorCenter = FR.extend(BI.MVCWidget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AnalysisETLOperatorCenter.superclass._defaultConfig.apply(this, arguments), {
            ...
            showContent: true,
            contentItem : {
                value:SQLCst.ANALYSIS_TABLE_HISTORY_TABLE_MAP.CHOOSE_FIELD,
            ...
            previewOperator : SQLCst.ANALYSIS_ETL_PAGES.SELECT_DATA
        })
    },
    ...
    _createOperatorCard : function () {
        var items = [];
        var self = this;
        BI.each(SQLCst.ANALYSIS_TABLE_OPERATOR, function(idx, item){
            var pane = BI.createWidget({
                type: item.operatorType + SQLCst.ANALYSIS_TABLE_PANE,
                data :[]
            })
