BI.AnalysisETLOperatorAddColumnPane = BI.inherit(BI.MVCWidget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AnalysisETLOperatorAddColumnPane.superclass._defaultConfig.apply(this, arguments), {
            ...
            value:SQLCst.ANALYSIS_TABLE_HISTORY_TABLE_MAP.ADD_COLUMN,
            model :{
                columns:[]
            },
            controller : {
    ...
    _initView: function () {
        ...
        this.title = BI.createWidget({
            type:SQLCst.ANALYSIS_ETL_PAGES.ADD_COLUMN + SQLCst.ANALYSIS_TABLE_PANE + SQLCst.ANALYSIS_TABLE_TITLE
        })
        ...
        this.allColumnsPane = BI.createWidget({
            type:SQLCst.ANALYSIS_ETL_PAGES.ADD_COLUMN + SQLCst.ANALYSIS_TABLE_PANE + "_all",
            items: []
        });
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.ADD_COLUMN + SQLCst.ANALYSIS_TABLE_PANE, BI.AnalysisETLOperatorAddColumnPane);