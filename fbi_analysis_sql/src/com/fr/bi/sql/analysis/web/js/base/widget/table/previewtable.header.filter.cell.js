...
BI.AnalysisETLPreviewTableHeaderFilterCell = BI.inherit(BI.Widget, {
    ...
    _init: function () {
        ...
        op[SQLCst.FIELDS] = o[SQLCst.FIELDS];
        ...
        BI.createWidget({
            ...
            items:[{
                el : {
                    type:"bi.icon_button",
                    cls:BI.Utils.getSQLFieldClass(o.field_type),
...
$.shortcut(SQLCst.ANALYSIS_TABLE_OPERATOR_PREVIEW_HEADER + BI.ANALYSIS_ETL_HEADER.FILTER, BI.AnalysisETLPreviewTableHeaderFilterCell);