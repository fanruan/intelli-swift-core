...
BI.SelectDataLevel8Node = FR.extend(BI.NodeButton, {
    ...
    _createItemList : function (){
        return [[{
            ...
            value:SQLCst.ANALYSIS_TABLE_SET.EDIT
        }], [{
            text: BI.i18nText("BI-Rename"),
            value:SQLCst.ANALYSIS_TABLE_SET.RENAME
        }], [{
            text: BI.i18nText("BI-Copy"),
            value:SQLCst.ANALYSIS_TABLE_SET.COPY
        }], [{
            text: BI.i18nText("BI-Remove"),
            value:SQLCst.ANALYSIS_TABLE_SET.DELETE
        }]];
    },
...
$.shortcut("bi.select_data_level" + SQLCst.BUSINESS_TABLE_TYPE.ANALYSIS_TYPE + "_node", BI.SelectDataLevel8Node);