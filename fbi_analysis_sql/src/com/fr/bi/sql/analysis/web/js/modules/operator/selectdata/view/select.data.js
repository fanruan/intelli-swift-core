BI.AnalysisETLOperatorSelectData = BI.inherit(BI.MVCWidget, {
    ...
    _initView: function () {
        ...
        this.selectPane.on(BI.AnalysisETLSelectDataPane.EVENT_CLICK_ITEM, function (v) {
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.SELECT_DATA, BI.AnalysisETLOperatorSelectData);