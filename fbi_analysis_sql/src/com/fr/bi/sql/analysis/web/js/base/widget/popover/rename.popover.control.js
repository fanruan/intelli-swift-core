...
BI.ETLRenamePopoverController = BI.inherit(BI.Controller, {
    ...
    showPopover : function (name, renameChecker, callback) {
        ...
        BI.Popovers.create("etlTableRename", renamePopover, {width : 400, height : 320, container :  BI.Layers.create(SQLCst.ANALYSIS_POPUP_FOLATBOX_LAYER)}).open("etlTableRename");
