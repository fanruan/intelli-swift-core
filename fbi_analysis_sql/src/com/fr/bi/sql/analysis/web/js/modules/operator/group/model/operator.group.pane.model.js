BI.AnalysisETLOperatorGroupPaneModel = BI.inherit(BI.MVCModel, {
    ...
    _initDefault : function () {
        ...
        if(BI.isEmptyObject(dimension)) {
            ...
            var fields = parent[SQLCst.FIELDS];
    ...
    addDimensionByField: function (field) {
        ...
        dimensions[id] = {
            name: BI.Func.createSQLDistinctName(dimensions, field["field_name"]),
            _src: {
                field_type: type,
    ...
    update : function () {
        ...
        v.etlType = SQLCst.ETL_TYPE.GROUP_SUMMARY;
    ...
    check : function () {
        ...
        var found = BI.some(view[BICst.REGION.DIMENSION1], function (i, v) {
            var  dimension = dimensions[v];
            var f = BI.find(parent[SQLCst.FIELDS], function (idx, field) {
...
SQLCst.OPERATOR_MODEL_CLASS[SQLCst.ANALYSIS_ETL_PAGES.GROUP_SUMMARY] =  BI.AnalysisETLOperatorGroupPaneModel;