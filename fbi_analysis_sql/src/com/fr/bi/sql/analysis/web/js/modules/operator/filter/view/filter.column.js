BI.AnalysisETLOperatorFilterSingleColumn = FR.extend(BI.Widget, {
    ...
    _createValueItems : function (data) {
        ...
        BI.each(data.value, function(idx, item){
            ...
            items.push({
                type:SQLCst.ANALYSIS_ETL_PAGES.FILTER + "_single_content",
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.FILTER + "_single_column", BI.AnalysisETLOperatorFilterSingleColumn)