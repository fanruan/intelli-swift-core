BI.SQLLeftPointer = FR.extend(BI.Single, {
    _defaultConfig: function() {
        var conf = BI.SQLLeftPointer.superclass._defaultConfig.apply(this, arguments);
    ...
    _init : function() {
        this._switchOptions();
        BI.SQLLeftPointer.superclass._init.apply(this, arguments);
        var opts = this.options;
        this.element.css({
...
$.shortcut("bi.left_pointer_sql", BI.SQLLeftPointer);