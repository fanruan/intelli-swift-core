BI.AnalysisETLOperatorGroupPane = FR.extend(BI.MVCWidget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AnalysisETLOperatorGroupPane.superclass._defaultConfig.apply(this, arguments), {
            ...
            value:SQLCst.ANALYSIS_TABLE_HISTORY_TABLE_MAP.GROUP
        })
    },
...
$.shortcut(SQLCst.ANALYSIS_ETL_PAGES.GROUP_SUMMARY + SQLCst.ANALYSIS_TABLE_PANE , BI.AnalysisETLOperatorGroupPane);