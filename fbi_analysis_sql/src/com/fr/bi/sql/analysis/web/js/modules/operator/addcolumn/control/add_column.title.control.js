BI.AnalysisETLOperatorAddColumnPaneTitleController = BI.inherit(BI.MVCController, {
    ...
    _getDefaultColumnName : function () {
        return BI.Utils.createSQLDistinctName(this.columnNames, BI.i18nText("BI-New_Column_Name"))
    },
    ...
    changeColumnType : function () {
        ...
        var acceptTypes = SQLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[type];
    ...
    populate : function () {
        ...
        var acceptTypes = SQLCst.ANALYSIS_ADD_COLUMN_TYPE_ACCEPT_FIELDS[model.getAddColumnType()];
        widget.fieldTypeSegment.setEnabledValue(acceptTypes);
