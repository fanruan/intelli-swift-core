BI.AnalysisETLOperatorMergeSheetPaneController = BI.inherit(BI.MVCController, {
    ...
    populate : function (widget, model) {
        var tables = model.get(SQLCst.PARENTS);
        widget.table.empty();
        ...
        widget.fireEvent(BI.AnalysisETLOperatorAbstractController.PREVIEW_CHANGE, model, SQLCst.ANALYSIS_TABLE_OPERATOR_KEY.NULL)
    ...
    editMerge : function (widget, model) {
        ...
        var currentTable = [];
        BI.each(model.get(SQLCst.PARENTS), function (idx, item) {
