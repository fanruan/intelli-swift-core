 ...
 */
public class AnalysisSQLDataSourceManager extends BISystemDataManager<DataSourceCompoundService> implements BIAnalysisSQLDataSourceManagerProvider {
    public DataSourceCompoundService getInstance() {
        try {
            return getValue(UserControl.getInstance().getSuperManagerID());
        } catch (BIKeyAbsentException e) {
            throw new NullPointerException("AnalysisSQLDataSourceManager init failed");
        }
    ...
    public String managerTag() {
        return "AnalysisSQLDataSourceManager";
    }

    @Override
    public String persistUserDataName(long key) {
        return "sus" + File.separator + "datasource";
    }
