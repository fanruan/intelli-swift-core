 ...
 */
public class AnalysisSQLBusiPackManager extends BISystemDataManager<SingleUserAnalysisSQLBusiPackManager> implements BIAnalysisSQLBusiPackManagerProvider {

    private static final String TAG = "AnalysisSQLBusiPackManager";

    public SingleUserAnalysisSQLBusiPackManager getUserAnalysisBusiPackManager(long userId) {
        try {
    ...
    @Override
    public SingleUserAnalysisSQLBusiPackManager constructUserManagerValue(Long userId) {
        return BIFactoryHelper.getObject(SingleUserAnalysisSQLBusiPackManager.class, userId);
    }
    ...
    public String persistUserDataName(long key) {
        return "sus" + File.separator + "pack" + key;
    }
     ...
     */
    @Override
    public AnalysisSQLBusiTable getTable(String tableId, long userId) throws BITableAbsentException {
