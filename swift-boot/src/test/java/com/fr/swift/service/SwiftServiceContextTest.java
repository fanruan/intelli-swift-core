...
public class SwiftServiceContextTest {
    ...
    public void setUp() throws Exception {
        ...
        PowerMockito.when(beanFactory.getBean(SwiftSegmentService.class)).thenReturn(mock(SwiftSegmentService.class));

        mockStatic(TaskProducer.class);
        PowerMockito.when(TaskProducer.produceTask(ArgumentMatchers.<ExecutorTask>any())).thenReturn(true);
    }
