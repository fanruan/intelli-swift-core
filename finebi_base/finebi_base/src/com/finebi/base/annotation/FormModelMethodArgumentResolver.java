...
import com.finebi.web.mock.web.test.MockHttpServletRequest;
...
import com.fr.third.springframework.validation.BindException;
import com.fr.third.springframework.validation.DataBinder;
import com.fr.third.springframework.validation.Errors;
import com.fr.third.springframework.web.bind.ServletRequestDataBinder;
import com.fr.third.springframework.web.bind.ServletRequestParameterPropertyValues;
...
import com.fr.third.springframework.web.context.request.RequestAttributes;
...
import com.fr.third.springframework.web.multipart.MultipartRequest;
...
public class FormModelMethodArgumentResolver implements HandlerMethodArgumentResolver {
     ...
     * {@link } that can perform the conversion.
     *
