package com.finebi.base.locale;
...
public class BIInter {
    ...
    private static void loadLanguageInProject(Locale locale) {
        ...
        try {
            ResourceBundle rb = ResourceBundle.getBundle("com.finebi.base.locale/fbi", locale, Inter.class.getClassLoader());
    ...
    private static void loadLanguageFromEnv(Locale locale) {
        ...
        try {
            InputStream in = env.readBean("fbi_" + locale.toString() + ".properties",   "classes/com/fr/bi/web/"+ ProjectConstants.LOCALE_NAME);
