...
public class SwiftServiceAddressConfig extends SwiftAbstractObjectMapConfig<RpcServiceAddress> {
    ...
    public boolean addOrUpdateAddress(String key, RpcServiceAddress value) {
        return super.addOrUpdate(key, value);
    }

    public RpcServiceAddress getAddressByServiceName(String serviceName) {
