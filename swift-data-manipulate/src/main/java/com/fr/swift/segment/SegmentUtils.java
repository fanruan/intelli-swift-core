...
public class SegmentUtils {
    ...
    public static Segment newSegment(SegmentKey segmentKey, int tmpPath) {
        ...
        return newSegment(location, metaData);
    }
    ...
    private static void clearRealtimeSegment(SegmentKey segKey) {
        SwiftContext.get().getBean(IResourceDiscovery.class).releaseSegment(segKey.getSwiftSchema(), segKey.getTable(), segKey.getOrder());
