...
public class BITablePair {
    private IBusinessTable from;
    private IBusinessTable to;

    public BITablePair(IBusinessTable from, IBusinessTable to) {
        BINonValueUtils.checkNull(from, to);
        this.from = from;
        this.to = to;
    }

    public IBusinessTable getFrom() {
        return from;
    }

    public IBusinessTable getTo() {
        return to;
    }
