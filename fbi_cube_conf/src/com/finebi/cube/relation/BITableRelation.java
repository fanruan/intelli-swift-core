 ...
 * @author Daniel-pc
 */
public class BITableRelation extends BIBasicRelation<IBusinessTable, IBusinessField> implements JSONTransform{
    public BITableRelation() {
    }

    public BITableRelation(IBusinessField primaryField, IBusinessField foreignField) {
