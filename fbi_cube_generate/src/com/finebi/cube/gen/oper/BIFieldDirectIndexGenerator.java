 ...
 * @author anchore
 */
public class BIFieldDirectIndexGenerator<T> {
    ...
    public BIFieldDirectIndexGenerator(Cube cube, CubeTableSource tableSource, ICubeFieldSource hostBICubeFieldSource, BIColumnKey targetColumnKey) {
