 ...
 */
public class BISourceDataPartTransportTestTool extends BISourceDataPartTransport {
    ...
    public BISourceDataPartTransportTestTool(Cube cube, CubeTableSource tableSource, Set<CubeTableSource> allSources, Set<CubeTableSource> parentTableSource, int oldCount) {
