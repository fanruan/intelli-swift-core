...
public class BICubeOperationManager4IncrementalTest extends BICubeTestBase {
    ...
    public void testDependPath() {
        try {
            ...
            BITableSourceRelationPath4Incremetal biTableSourceRelationPath4Incremetal = calculateDependManager4Test.calRelationPath(abcPath, relationsGenerated);
    ...
    * 假设A已经存在，现在更新relationAB*/
    public void testTableRelation() {
        try {
            ...
            BITableSourceRelation4Incremental biTableSourceRelation4Incremental = new BITableSourceRelation4Incremental(BITableSourceRelationTestTool.getMemoryAB(),analysisTableSources);
