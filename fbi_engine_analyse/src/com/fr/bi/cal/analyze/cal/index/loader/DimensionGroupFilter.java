...
//    }
//
//    private void calCalculateTarget(BINode mergeNode) {
...
//        BINode sortedNode = buildTreeNode(groupValueIndexe2D, counter, nodeBuilder);
//        for (MergerInfo info : mergerInfoList) {
...
//    }
//
//    private BINode buildTreeNode(GroupValueIndex[][] groupValueIndexe2D, RowCounter counter, TreeBuilder nodeBuilder) {
...
//        }
//        BINode retNode = filterBuilder.build();
//
//
//        if (hasTargetSort()) {
...
//    }
//
//    private BINode clearNull(BINode node, int deep) {
//        BINode newNode = MergerNode.copyNode(node);
//        for (int i = 0; i < node.getChildLength(); i++) {
//            BINode childNode = clearNull(node.getChild(i), deep + 1);
...
//    }
//
//    private boolean hasChild(BINode node) {
//        return node.getChildLength() != 0;
//    }
//
//    private BINode sum(BINode node) {
//        BINode retNode = sumNode(node);
//        //没child就没计算了
...
//    }
//
//    private BINode sortNode(BINode retNode) {
//        ISortInfoList sortInfoList = createSortInfoList();
//
//        BINode sortedNode = retNode.createSortedNode(targetSort, targetsMap, sortInfoList, 0);
...
//    }
//
//    private BINode sumNode(BINode sortedNode) {
