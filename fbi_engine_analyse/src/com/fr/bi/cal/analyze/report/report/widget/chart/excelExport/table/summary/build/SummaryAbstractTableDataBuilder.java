 ...
 */
public abstract class SummaryAbstractTableDataBuilder implements IExcelDataBuilder {
    ...
    protected List<BITableHeader> headers;
    ...
    protected void initAllAttrs() {
        ...
        items = new JSONArray();
        headers = new ArrayList<BITableHeader>();
