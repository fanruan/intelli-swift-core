 ...
 */
public abstract class AbstractVanChartWidget {
...
//        super.parseJSON(jo, userId);
    ...
    * */
    ...
    public String getCategoryDimensionID(int index) {
        List<String> dimensionIds = widgetConf.getView().get(Integer.parseInt(BIReportConstant.REGION.DIMENSION1));
    ...
    public String getSeriesDimensionID() {
        List<String> dimensionIds = widgetConf.getView().get(Integer.parseInt(BIReportConstant.REGION.DIMENSION2));
        if (dimensionIds == null) {
            return null;
        }
        JSONObject dimensions = widgetConf.getDimensions();
    ...
    protected String[] getUsedTargetID() {
        Map<Integer, List<String>> view = widgetConf.getView();
