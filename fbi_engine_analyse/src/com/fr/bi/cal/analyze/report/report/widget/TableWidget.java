...
public class TableWidget extends BISummaryWidget {
    ...
    public JSONObject getPostOptions(BISessionProvider session, HttpServletRequest req) throws Exception {
        JSONObject jo=new JSONObject("{\n" +
                ...
                "      \"text\": \"分期付款\",\n" +
                "      \"value\": \"ed3830e2811558eb分期付款\",\n" +
                "      \"tag\": \"2423202bd74d76f8\",\n" +
                "      \"dId\": \"ed3830e2811558eb\",\n" +
                "      \"isCross\": true,\n" +
                "      \"styles\": {\n" +
                "        \"background\": \"#04b1c2\",\n" +
                "        \"color\": \"#ffffff\"\n" +
                ...
                "      \"type\": \"bi.normal_expander_cell\",\n" +
                "      \"text\": \"一次性付款\",\n" +
                "      \"value\": \"ed3830e2811558eb一次性付款\",\n" +
                "      \"tag\": \"7a69cfcc6dbce154\",\n" +
                "      \"dId\": \"ed3830e2811558eb\",\n" +
                "      \"isCross\": true,\n" +
                "      \"styles\": {\n" +
                "        \"background\": \"#04b1c2\",\n" +
                ...
                "    {\n" +
                "      \"type\": \"bi.normal_header_cell\",\n" +
                "      \"dId\": \"94dc469a067b4bb3\",\n" +
                "      \"text\": \"汇总:合同金额\",\n" +
                "      \"tag\": \"4845da16f4466f6c\",\n" +
                "      \"styles\": {\n" +
                "        \"background\": \"#04b1c2\",\n" +
                "        \"color\": \"#ffffff\"\n" +
                "      },\n" +
                ...
                "                  ],\n" +
                "                  \"styles\": {\n" +
                "                    \"background\": \"rgba(4,177,194,0.2)\",\n" +
                "                    \"filter\": \"progid:DXImageTransform.Microsoft.gradient(startColorstr=#3304b1c2,endColorstr=#3304b1c2);\"\n" +
                "                  }\n" +
                "                },\n" +
                "                {\n" +
                "                  \"type\": \"bi.target_body_normal_cell\",\n" +
                ...
                "                  ],\n" +
                "                  \"styles\": {\n" +
                "                    \"background\": \"rgba(4,177,194,0.05)\",\n" +
                "                    \"filter\": \"progid:DXImageTransform.Microsoft.gradient(startColorstr=#0D04b1c2,endColorstr=#0D04b1c2);\"\n" +
                "                  }\n" +
                "                },\n" +
                "                {\n" +
                "                  \"type\": \"bi.target_body_normal_cell\",\n" +
                ...
                "              \"styles\": {\n" +
                "                \"fontWeight\": \"bold\",\n" +
                "                \"background\": \"rgba(4,177,194,0.4)\",\n" +
                "                \"filter\": \"progid:DXImageTransform.Microsoft.gradient(startColorstr=#6604b1c2,endColorstr=#6604b1c2);\"\n" +
                "              }\n" +
                "            },\n" +
                "            {\n" +
                "              \"type\": \"bi.target_body_normal_cell\",\n" +
...
//        .put("crossItems",jo.get("crossItems")).put("crossHeader",jo.get("crossHeader")).put("header",jo.get("header")).put("items",jo.get("items"));
