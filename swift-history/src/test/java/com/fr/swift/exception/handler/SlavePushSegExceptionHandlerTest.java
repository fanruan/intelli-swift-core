...
@PrepareForTest(SlavePushSegExceptionHandler.class)
public class SlavePushSegExceptionHandlerTest {
    ...
    public void handleException() throws Exception {
        ...
        SlavePushSegExceptionHandler slavePushSegExceptionHandler = mock(SlavePushSegExceptionHandler.class);
