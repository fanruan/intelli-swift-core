...
public interface BITableRelationConfigurationProvider {
     ...
     * @return 表与关联集合的MAP
     */
    Map<Table, IRelationContainer> getAllTable2PrimaryRelation(long userId);
     ...
     * @return 表与关联集合的MAP
     */
    Map<Table, IRelationContainer> getAllTable2ForeignRelation(long userId);
     ...
     */
    Set<BITableRelationPath> getAllPath(long userId, Table juniorTable, Table primaryTable) throws BITableUnreachableException,
    ...
    Set<BITableRelationPath> getAllAvailablePath(long userId, Table juniorTable, Table primaryTable) throws BITableUnreachableException,
            BITableAbsentException, BITableRelationConfusionException, BITablePathConfusionException;
     ...
     */
    BITableRelationPath getFirstPath(long userId, Table juniorTable, Table primaryTable) throws BITableUnreachableException;
     ...
     * @throws BITableUnreachableException 表不可达
     */
    BITableRelationPath getFirstAvailablePath(long userId, Table primaryTable, Table juniorTable) throws BITableUnreachableException;
     ...
     * @return 公共子类表
     */
    BITableContainer getCommonSonTables(long userId, Set<Table> tables);
    ...
    boolean containTablePrimaryRelation(long userId, BITable table);

    boolean containTableForeignRelation(long userId, BITable table);
     ...
     * @return 是否可达
     */
    boolean isReachable(long userId, Table juniorTable, Table primaryTable);

    IRelationContainer getPrimaryRelation(long userId, Table table) throws BITableAbsentException;

    IRelationContainer getForeignRelation(long userId, Table table) throws BITableAbsentException;
