...
import com.fr.bi.conf.base.relation.relation.*;
...
public class BITableRelationAnalyser implements BITableRelationAnalysisService {
    ...
    @Override
    public IRelationContainer getForeignRelation(Table table) throws BITableAbsentException {
        synchronized (relationContainerService) {
    ...
    @Override
    public boolean containTablePrimaryRelation(Table table) {
        synchronized (relationContainerService) {
    ...
    @Override
    public boolean containTableForeignRelation(Table table) {
        synchronized (relationContainerService) {
