 ...
 */
@BIMandatedObject(factory = IFactoryService.CONF_XML, implement = BIPackagesManagerService.class)
public class BIPackageContainer extends BISetContainer<BIBusinessPackage> implements BIPackagesManagerService {
