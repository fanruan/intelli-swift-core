...
import com.fr.bi.conf.base.pack.group.BIGroupTagsManagerService;
...
public class BIPackageConfigManager implements Release {
    ...
    public BIPackageConfigManager(long userId) {
        ...
        analysisPackageManager = BIFactoryHelper.getObject(BIPackagesManagerService.class, userId);
        currentPackageManager = BIFactoryHelper.getObject(BIPackagesManagerService.class, userId);
        groupCollectionManager = BIFactoryHelper.getObject(BIGroupTagsManagerService.class, userId);
    }

    public BIPackagesManagerService getAnalysisPackageManager() {
        return analysisPackageManager;
    }

    protected BIPackagesManagerService getCurrentPackageManager() {
    ...
    protected BIGroupTagsManagerService getGroupCollectionManager() {
    ...
    public void stickGroupTagOnPackage(BIPackageID packageID, BIGroupTagName groupTagName) throws BIPackageAbsentException, BIGroupAbsentException, BIPackageDuplicateException {
        BIBusinessPackageGetterService biBusinessPackage = getPackage(packageID);
        ...
        synchronized (groupCollectionManager) {
            ...
            if (jo.has("changedPackage")) {
                ...
                if (changedPackage != null) {
                    ...
                    BIBusinessPackageGetterService pack = null;
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                try {
                    ...
                    for (int j = 0; j < jt.length(); j++) {
                        ...
                        BIBusinessPackageGetterService biPackage = currentPackageManager.getPackage(id);
