 ...
 */
@BIMandatedObject(factory = IFactoryService.CONF_XML, implement = BIGroupTagsManagerService.class)
public class BIGroupTagContainer extends BITreeMapContainer<BIGroupTagName, BIBusinessGroup> implements BIGroupTagsManagerService {
     ...
     * @return
     */
    public Set<BIBusinessGroupGetterService> getGroups() {
        Set<BIBusinessGroupGetterService> result = new HashSet<BIBusinessGroupGetterService>();
    ...
    public Set<BIBusinessPackage> getTaggedPackages() {
        synchronized (container) {
            ...
            Iterator<BIBusinessGroupGetterService> it = getGroups().iterator();
            while (it.hasNext()) {
                BIBusinessGroupGetterService biBusinessGroup = it.next();
    ...
    @Override
    public BIBusinessGroupGetterService getReadableGroup(BIGroupTagName groupName) throws BIGroupAbsentException {
