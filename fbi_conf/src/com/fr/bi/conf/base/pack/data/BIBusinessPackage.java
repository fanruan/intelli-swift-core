 ...
 */
public abstract class BIBusinessPackage<T extends BIBusinessTable> extends BISetContainer<T> implements JSONTransform, FCloneable, BIBusinessPackageGetterService<T> {
    ...
    public BIBusinessPackage(BIPackageID id) {
        this(id, BIPackageName.DEFALUT, BIUser.DEFALUT,System.currentTimeMillis());
    }
