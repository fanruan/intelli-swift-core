 ...
 * <p>
 * See package description for {@link com.fr.swift.query.aggregator.extension.histogram} for details.
 */
class DoubleHistogram extends EncodableHistogram implements DoubleValueRecorder, Serializable {
...
//    volatile double integerToDoubleValueConversionRatio;
     ...
     * of significant decimal digits.
     * <p>
     * The {@link com.fr.swift.query.aggregator.extension.histogram.DoubleHistogram}
     * will use the specified AbstractHistogram subclass
     * for tracking internal counts (e.g. {@link com.fr.swift.query.aggregator.extension.histogram.Histogram}
     *
     * @param numberOfSignificantValueDigits Specifies the precision to use. This is the number of significant
     *                                       decimal digits to which the histogram will maintain value resolution
     *                                       and separation. Must be a non-negative integer between 0 and 5.
     ...
     * decimal digits.
     * <p>
     * The {@link com.fr.swift.query.aggregator.extension.histogram.DoubleHistogram} will use the specified AbstractHistogram subclass
     * for tracking internal counts (e.g. {@link com.fr.swift.query.aggregator.extension.histogram.Histogram}
     *
     * @param highestToLowestValueRatio      specifies the dynamic range to use.
     * @param numberOfSignificantValueDigits Specifies the precision to use. This is the number of significant
...
//            }
    ...
    /**
     * Construct a {@link com.fr.swift.query.aggregator.extension.histogram.DoubleHistogram} with the same range settings as a given source,
     ...
     * {@link com.fr.swift.query.aggregator.extension.histogram.HistogramIterationValue#getDoubleValueIteratedTo() getDoubleValueIteratedTo()}
     * and
     * {@link com.fr.swift.query.aggregator.extension.histogram.HistogramIterationValue#getDoubleValueIteratedFrom() getDoubleValueIteratedFrom()}
     * accessors to {@link com.fr.swift.query.aggregator.extension.histogram.HistogramIterationValue} iterated values.
     *
     ...
     * {@link com.fr.swift.query.aggregator.extension.histogram.DoubleHistogram#valuesAreEquivalent} would return true.
     *
     ...
     * {@link com.fr.swift.query.aggregator.extension.histogram.Histogram}
     *
     * @param buffer                             The buffer to decode from
     * @param internalCountsHistogramClass       The class to use for internal counts tracking
     * @param minBarForHighestToLowestValueRatio Force highestTrackableValue to be set at least this high
