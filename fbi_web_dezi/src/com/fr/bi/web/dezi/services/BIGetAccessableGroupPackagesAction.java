...
public class BIGetAccessableGroupPackagesAction extends AbstractBIDeziAction {

    @Override
    public String getCMD() {
        return "get_accessable_group_packages";
    }
    ...
    public void actionCMD(HttpServletRequest req, HttpServletResponse res,
        ...
        WebUtils.printAsJSON(res, BIConfigureManagerCenter.getPackageManager().createGroupJSON(userId));
    }
