...
public abstract class BaseNumberFilterTest extends BaseFilterTest {
    ...
    private static void initColumn() {
        intColumn = new BaseColumnImplTest<Integer>(intDetails, Comparators.<Integer>asc(), null) {
            @Override
            protected Integer convertValue(Object value) {
                return ((Number) value).intValue();
            }
        };
        doubleColumn = new BaseColumnImplTest<Double>(doubleDetails, Comparators.<Double>asc(), null) {
            @Override
            protected Double convertValue(Object value) {
                return ((Number) value).doubleValue();
            }
        };
        longColumn = new BaseColumnImplTest<Long>(longDetails, Comparators.<Long>asc(), null) {
            @Override
