...
//        try {
//            SwiftServiceListenerHandler handler = ProxySelector.getInstance().getFactory().getProxy(SwiftServiceListenerHandler.class);
//            handler.trigger(new CheckLoadHistoryEvent(getID()));
...
//            try {
//                SwiftServiceListenerHandler handler = ProxySelector.getInstance().getFactory().getProxy(SwiftServiceListenerHandler.class);
//                handler.trigger(new PushSegLocationRpcEvent(info));
