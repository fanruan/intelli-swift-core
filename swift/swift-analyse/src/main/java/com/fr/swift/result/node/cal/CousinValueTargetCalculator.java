...
public class CousinValueTargetCalculator extends AbstractCousinTargetCalculator {
    public CousinValueTargetCalculator(int[] paramIndex, int resultIndex, GroupNode groupNode, List<Map<Integer, Object>> dic, Function<GroupNode, List<AggregatorValue[]>> aggFunc, List<Pair<Integer, GroupType>> brotherGroupIndex) {
