...
import com.fr.swift.bitmap.roaringbitmap.BitmapDataProvider;
import com.fr.swift.bitmap.roaringbitmap.ContainerPointer;
import com.fr.swift.bitmap.roaringbitmap.RoaringBitmap;
 ...
 * com.fr.swift.bitmap.roaringbitmap.RoaringBitmap, but it differs in that it can interact with
 ...
 * <p>
 * A MutableRoaringBitmap can be used much like an com.fr.swift.bitmap.roaringbitmap.RoaringBitmap instance, and
 ...
 * @see com.fr.swift.bitmap.roaringbitmap.RoaringBitmap
 */
public class MutableRoaringBitmap extends ImmutableRoaringBitmap
    ...
    public void naivelazyor(final ImmutableRoaringBitmap x2) {
        int pos1 = 0, pos2 = 0;
        int length1 = highLowContainer.size();
        final int length2 = x2.highLowContainer.size();
        main:
