 ...
 */
public class InterH5 implements LocaleProvider {
    ...
    private static void loadLanguageInProject(Locale locale) {
        ...
        try {
            ResourceBundle rb = ResourceBundle.getBundle("com/fr/bi/h5/locale/h5", locale, Inter.class.getClassLoader());
    ...
    private static void loadLanguageFromEnv(Locale locale) {
        ...
        try {
            InputStream in = env.readBean("h5_" + locale.toString() + ".properties",   "classes/com/fr/bi/h5/"+ ProjectConstants.LOCALE_NAME);
