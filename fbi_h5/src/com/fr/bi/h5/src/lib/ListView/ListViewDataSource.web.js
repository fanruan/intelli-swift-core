...
function defaultGetRowData(dataBlob:any,
                           sectionID,
                           rowID):any {
  return dataBlob[sectionID][rowID];
}

function defaultGetSectionHeaderData(dataBlob:any,
                                     sectionID,):any {
...
class ListViewDataSource {
  ...
  cloneWithRows(dataBlob,
                rowIdentities:Array<string>):ListViewDataSource {
  ...
  cloneWithRowsAndSections(dataBlob:any,
                           ...
                           rowIdentities:Array):ListViewDataSource {
    invariant(
  ...
  _calculateDirtyArrays(prevDataBlob:any,
                        prevSectionIDs:Array<string>,
                        prevRowIDs:Array<>):void {
    ...
    for (var sIndex = 0; sIndex < this.sectionIdentities.length; sIndex++) {
      ...
      for (var rIndex = 0; rIndex < this.rowIdentities[sIndex].length; rIndex++) {
        ...
        dirty =
          !prevSectionsHash[sectionID] || !prevRowsHash[sectionID][rowID] ||
          this._rowHasChanged(
