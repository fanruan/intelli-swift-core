...
class Collapsible extends Component {
    ...
    render() {
        ...
        return (
            <Animated.View className = {''} style={style} pointerEvents={this.props.collapsed ? 'none' : 'auto'}>
                <Animated.View className = {''} style={[this.props.style, contentStyle]} onLayout={this.state.animating ? undefined : event => this._handleLayoutChange(event)}>
                    {this.props.children}
                </Animated.View>
            </Animated.View>
        );
