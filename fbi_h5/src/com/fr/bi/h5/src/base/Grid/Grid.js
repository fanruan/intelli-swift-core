...
import createCallbackMemoizer from '../Utilties/createCallbackMemoizer'
import getOverscanIndices from './utils/getOverscanIndices'
import getScrollbarSize from 'dom-helpers/util/scrollbarSize'
import updateScrollIndexHelper from './utils/updateScrollIndexHelper'
import defaultCellRangeRenderer from './defaultCellRangeRenderer'

import {cancelAnimationFrame,requestAnimationFrame} from 'core'
...
class Grid extends Component {
  ...
  _setNextState (state) {
    ...
    if (!this._setNextStateAnimationFrameId) {
      this._setNextStateAnimationFrameId = requestAnimationFrame(this._setNextStateCallback)
    }
  }
...
mixin.onClass(Grid, ReactComponentWithPureRenderMixin);
