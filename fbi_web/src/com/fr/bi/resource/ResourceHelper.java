...
public class ResourceHelper {
    ...
    private static String[] getDeziJSModule() {
        return new String[]{
                ...
                //明细表
                "com/fr/bi/web/js/modules/detailtable/adaptivetable/table.adaptive.js",
                "com/fr/bi/web/js/modules/detailtable/sequencetable/listnumber.sequencetable.js",
                "com/fr/bi/web/js/modules/detailtable/sequencetable/sequencetable.js",
                "com/fr/bi/web/js/modules/detailtable/pagetable/pagetable.cell.js",
                "com/fr/bi/web/js/modules/detailtable/pagetable/pagetable.js",
                "com/fr/bi/web/js/modules/detailtable/helper/summarytable.helper.js",
    ...
    private static String[] getDeziCssModule() {
        return new String[]{
                ...
                //明细表表格
                "com/fr/bi/web/css/modules/detailtable/sequencetable/listnumber.sequencetable.css",
                "com/fr/bi/web/css/modules/detailtable/pagetable/pagetable.cell.css",
    ...
    public static String[] getDeziCss() {
        String[] module = getDeziCssModule();
        return (String[]) ArrayUtils.addAll(module, new String[]{
    ...
    public static String[] getConfCss() {
        String[] module = getConfCssModule();
        return (String[]) ArrayUtils.addAll(module, new String[]{
...
//                "com/fr/bi/web/js/base/module/table/table.fix.js",
                ...
                "com/fr/bi/web/js/case/pager/pager.js",
    ...
    public static String createDefaultJs(Locale locale) throws Exception {
        ...
        if (js == null) {
            synchronized (ResourceHelper.class) {
                ...
                js = new StringBuffer().append(un_ne_js).append(createI18NJs(locale)).toString();
