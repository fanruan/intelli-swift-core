...
BIShow.CustomGroupView = BI.inherit(BI.BarFloatSection, {
    _defaultConfig: function () {
        return BI.extend(BIShow.CustomGroupView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-custom-group-floatbox"
        })
    },
    _init: function () {
        BIShow.CustomGroupView.superclass._init.apply(this, arguments);
    },
