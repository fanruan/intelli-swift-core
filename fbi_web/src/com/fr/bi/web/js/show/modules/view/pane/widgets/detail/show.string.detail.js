/**
 * @class BIShow.StringDetailView
 * @extends BI.View
 *
 */
BIShow.StringDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.StringDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIShow.StringDetailView.superclass._init.apply(this, arguments);
    },
