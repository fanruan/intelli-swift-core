/**
 * @class BIShow.DateWidgetView
 * @extends BI.View
 * @type {*|void|Object}
 */
BIShow.DateWidgetView = BI.inherit(BI.View, {
    _defaultConfig: function () {
        return BI.extend(BIShow.DateWidgetView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-dashboard-widget"
        })
    },

    _init: function () {
        BIShow.DateWidgetView.superclass._init.apply(this, arguments);
        var self = this;
