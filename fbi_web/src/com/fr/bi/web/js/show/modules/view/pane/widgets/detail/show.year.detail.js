/**
 * @class BIShow.YearDetailView
 * @extends BI.View
 *
 */
BIShow.YearDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.YearDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIShow.YearDetailView.superclass._init.apply(this, arguments);
    },
