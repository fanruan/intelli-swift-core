/**
 * @class BIShow.DateDetailView
 * @extends BI.View
 *
 */
BIShow.DateDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.DateDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIShow.DateDetailView.superclass._init.apply(this, arguments);
    },
