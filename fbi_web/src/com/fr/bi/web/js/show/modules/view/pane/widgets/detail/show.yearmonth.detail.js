/**
 * @class BIShow.YearMonthDetailView
 * @extends BI.View
 *
 */
BIShow.YearMonthDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.YearMonthDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIShow.YearMonthDetailView.superclass._init.apply(this, arguments);
    },
