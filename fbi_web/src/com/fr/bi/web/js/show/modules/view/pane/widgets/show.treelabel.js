 ...
 */
BIShow.TreeLabelView = BI.inherit(BI.View, {
    _constants: {
        TOOL_ICON_WIDTH: 20,
        TOOL_ICON_HEIGHT: 20
    },
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.TreeLabelView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-dashboard-widget bi-control-widget"
        })
    },

    _init: function () {
        BIShow.TreeLabelView.superclass._init.apply(this, arguments);
        var self = this;
