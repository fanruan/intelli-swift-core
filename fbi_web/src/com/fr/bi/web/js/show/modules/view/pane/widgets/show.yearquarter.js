/**
 * @class BIShow.YearQuarterWidgetView
 * @extends BI.View
 * @type {*|void|Object}
 */
BIShow.YearQuarterWidgetView = BI.inherit(BI.View, {
    _defaultConfig: function () {
        return BI.extend(BIShow.YearQuarterWidgetView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-dashboard-widget"
        })
    },

    _init: function () {
        BIShow.YearQuarterWidgetView.superclass._init.apply(this, arguments);
        var self = this;
