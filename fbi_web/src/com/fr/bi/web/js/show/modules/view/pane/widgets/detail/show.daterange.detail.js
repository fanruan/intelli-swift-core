/**
 * @class BIShow.DateRangeDetailView
 * @extends BI.View
 *
 */
BIShow.DateRangeDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIShow.DateRangeDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIShow.DateRangeDetailView.superclass._init.apply(this, arguments);
    },
