BIDezi.StringDimensionView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.StringDimensionView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-dimension"
        })
    },

    _init: function () {
        BIDezi.StringDimensionView.superclass._init.apply(this, arguments);
    },
