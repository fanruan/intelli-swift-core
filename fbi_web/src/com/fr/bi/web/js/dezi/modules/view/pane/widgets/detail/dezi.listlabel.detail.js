 ...
 */
BIDezi.ListLabelDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.ListLabelDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.ListLabelDetailView.superclass._init.apply(this, arguments);
    },
    ...
    _buildCenter: function () {
        var listLabel = this._createListLabel();
