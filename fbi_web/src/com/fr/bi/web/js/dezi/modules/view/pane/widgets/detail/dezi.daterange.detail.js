/**
 * @class BIDezi.DateRangeDetailView
 * @extends BI.View
 *
 */
BIDezi.DateRangeDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.DateRangeDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.DateRangeDetailView.superclass._init.apply(this, arguments);
    },
