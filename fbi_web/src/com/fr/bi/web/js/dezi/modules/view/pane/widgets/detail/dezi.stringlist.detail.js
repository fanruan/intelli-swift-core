 ...
 */
BIDezi.StringListDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.StringListDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.StringListDetailView.superclass._init.apply(this, arguments);
    },
    ...
    _buildCenter: function () {
        var stringList = this._createCombo();
    ...
    splice: function (old, key1, key2) {
        if (key1 === "dimensions") {
            ...
            this.model.set("value", this.stringList.getValue());
        }
    },
