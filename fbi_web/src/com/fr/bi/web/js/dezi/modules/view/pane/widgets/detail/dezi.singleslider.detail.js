 ...
 */
BIDezi.SingleSliderDetailView = BI.inherit(BI.View, {
    constants: {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.SingleSliderDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.SingleSliderDetailView.superclass._init.apply(this, arguments);
    },
