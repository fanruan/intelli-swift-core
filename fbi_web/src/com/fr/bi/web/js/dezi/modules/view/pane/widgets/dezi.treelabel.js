 ...
 */
BIDezi.TreeLabelView = BI.inherit(BI.View, {
    _constants: {
        TOOL_ICON_WIDTH: 20,
        TOOL_ICON_HEIGHT: 20
    },
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.TreeLabelView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-dashboard-widget bi-control-widget"
        })
    },

    _init: function () {
        BIDezi.TreeLabelView.superclass._init.apply(this, arguments);
        var self = this;
        this.broadcasts = [];
    ...
    _refreshLayout: function () {
        ...
        this.treeLabel.setHeight(height - 50);
        this.widget.resize();
    },
