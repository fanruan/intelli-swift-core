/**
 * @class BIDezi.YearMonthDetailView
 * @extends BI.View
 *
 */
BIDezi.YearMonthDetailView = BI.inherit(BI.View, {
    ...
    _defaultConfig: function () {
        return BI.extend(BIDezi.YearMonthDetailView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-widget-attribute-setter"
        })
    },

    _init: function () {
        BIDezi.YearMonthDetailView.superclass._init.apply(this, arguments);
    },
