 ...
 * @class BI.RangeAreaRegionsManager
 * @extends BI.RegionsManager
 */
BI.RangeAreaRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.RangeAreaRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-range-area-regions-manager",
    ...
    _init: function () {
        BI.RangeAreaRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createTarget1RegionHeader: function () {
        ...
        var header = BI.createWidget({
            ...
            height: 26,
            titleName: BI.i18nText("BI-Low_Value_Axis"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
    ...
    _createTarget2RegionHeader: function () {
        ...
        var header = BI.createWidget({
            type: "bi.calculate_target_region_header",
            height: 26,
            titleName: BI.i18nText("BI-High_Value_Axis"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.range_area_regions_manager', BI.RangeAreaRegionsManager);