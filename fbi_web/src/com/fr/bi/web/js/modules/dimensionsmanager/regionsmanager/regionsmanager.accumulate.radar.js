 ...
 * @class BI.AccumulateRadarRegionsManager
 * @extends BI.RegionsManager
 */
BI.AccumulateRadarRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AccumulateRadarRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-accumulate-radar-regions-manager",
    ...
    _init: function () {
        BI.AccumulateRadarRegionsManager.superclass._init.apply(this, arguments);
