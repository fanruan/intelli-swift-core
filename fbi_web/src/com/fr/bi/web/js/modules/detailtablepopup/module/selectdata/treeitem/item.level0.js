 ...
 * @class BI.DetailTablePopupSelecDataLevel0Item
 * @extends BI.Single
 */
BI.DetailTablePopupSelecDataLevel0Item = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.DetailTablePopupSelecDataLevel0Item.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-detail-table-popup-select-data-level0-item",
            height: 25,
            hgap: 0,
    ...
    _init: function () {
        BI.DetailTablePopupSelecDataLevel0Item.superclass._init.apply(this, arguments);
        var self = this, o = this.options;
        this.button = BI.createWidget({
            type: "bi.blank_icon_text_item",
            trigger: "mousedown",
            cls: "detail-table-popup-select-data-level0-item-button " + this._getFieldClass(o.fieldType),
            blankWidth: 10,
            text: o.text,
            value: o.value,
            height: 25,
    ...
    setEnable: function (v) {
        BI.DetailTablePopupSelecDataLevel0Item.superclass.setEnable.apply(this, arguments)
...
$.shortcut("bi.detail_table_popup_select_data_level0_item", BI.DetailTablePopupSelecDataLevel0Item);