/**
 * @class BI.FormulaEmptyFilterItem
 * @extend BI.Widget
 * 过滤条件——公式
 */
BI.FormulaEmptyFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function(){
        return BI.extend(BI.FormulaEmptyFilterItem.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-analysis-formula-empty-filter-item"
        })
    },

    _init: function(){
        BI.FormulaEmptyFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildFormulaEmpty: function(){
        ...
        var formulaPopup = BI.createWidget({
            ...
            fieldItems: BI.isNotNull(o.dId) ? this._getTargetItems() : this._getFieldItems()
        });
...
$.shortcut("bi.formula_empty_filter_item", BI.FormulaEmptyFilterItem);