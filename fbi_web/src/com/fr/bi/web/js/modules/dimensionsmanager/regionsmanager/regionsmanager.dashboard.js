 ...
 * @class BI.DashboardRegionsManager
 * @extends BI.RegionsManager
 */
BI.DashboardRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.DashboardRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-dashboard-regions-manager",
    ...
    _init: function () {
        BI.DashboardRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.dashboard_regions_manager', BI.DashboardRegionsManager);