 ...
 * @class BI.RectTreeRegionsManager
 * @extends BI.RegionsManager
 */
BI.RectTreeRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.RectTreeRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-rect-tree-regions-manager",
    ...
    _init: function () {
        BI.RectTreeRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.rect_tree_regions_manager', BI.RectTreeRegionsManager);