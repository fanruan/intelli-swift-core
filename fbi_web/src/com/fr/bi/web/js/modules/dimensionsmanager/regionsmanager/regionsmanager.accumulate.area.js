 ...
 * @class BI.AccumulateAreaRegionsManager
 * @extends BI.RegionsManager
 */
BI.AccumulateAreaRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AccumulateAreaRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-accumulate-area-regions-manager",
    ...
    _init: function () {
        BI.AccumulateAreaRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.accumulate_area_regions_manager', BI.AccumulateAreaRegionsManager);