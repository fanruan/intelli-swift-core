/**
 * @class BI.HeatMapSetting
 * @extends BI.Widget
 * heat地图样式
 */
BI.HeatMapSetting = BI.inherit(BI.AbstractChartSetting, {

    _defaultConfig: function(){
        return BI.extend(BI.HeatMapSetting.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-charts-setting bi-heat-map-chart-setting"
        })
    },

    _init: function(){
        BI.HeatMapSetting.superclass._init.apply(this, arguments);
        ...
        this.showName.on(BI.Controller.EVENT_CHANGE, function () {
            ...
            self.fireEvent(BI.HeatMapSetting.EVENT_CHANGE);
        });
...
BI.HeatMapSetting.EVENT_CHANGE = "EVENT_CHANGE";
$.shortcut("bi.heat_map_setting", BI.HeatMapSetting);
