 ...
 */
BI.GeneralQueryNoTypeFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.GeneralQueryNoTypeFilterItem.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.GeneralQueryNoTypeFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditionsNoType: function () {
        ...
        selectFieldPane.on(BI.GeneralQuerySelectDataTab.EVENT_CHANGE, function (v) {
            self._onTypeSelected(v);
            self.options.afterValueChange();
        });
...
$.shortcut("bi.general_query_no_type_filter_item", BI.GeneralQueryNoTypeFilterItem);