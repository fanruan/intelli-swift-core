/**
 * @class BI.ConfNumberIntervalCustomItemGroup
 * @extend BI.Widget
 */

BI.ConfNumberIntervalCustomItemGroup = BI.inherit(BI.Widget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.ConfNumberIntervalCustomItemGroup.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.ConfNumberIntervalCustomItemGroup.superclass._init.apply(this, arguments);
        ...
        BI.each(buttons, function (idx, button) {
            ...
            button.on(BI.ConfNumberIntervalCustomGroupItem.EVENT_DESTROY, function () {
                if (self.buttons.length === 0) {
                    ...
                    self.fireEvent(BI.ConfNumberIntervalCustomItemGroup.EVENT_EMPTY_GROUP);
                    return;
                }
                if (self.isValid()) {
                    self.fireEvent(BI.ConfNumberIntervalCustomItemGroup.EVENT_VALID);
...
BI.ConfNumberIntervalCustomItemGroup.EVENT_ERROR = "EVENT_ERROR";
BI.ConfNumberIntervalCustomItemGroup.EVENT_EMPTY_GROUP = "EVENT_EMPTY_GROUP";
BI.ConfNumberIntervalCustomItemGroup.EVENT_VALID = "EVENT_VALID";

$.shortcut("bi.conf_number_custom_item_group", BI.ConfNumberIntervalCustomItemGroup);