 ...
 * @class BI.ParetoRegionsManager
 * @extends BI.RegionsManager
 */
BI.ParetoRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.ParetoRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-pareto-regions-manager",
    ...
    _init: function () {
        BI.ParetoRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.pareto_regions_manager', BI.ParetoRegionsManager);