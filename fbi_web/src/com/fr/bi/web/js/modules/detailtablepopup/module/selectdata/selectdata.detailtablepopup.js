 ...
 * @class BI.DetailTablePopupSelectData
 * @extends BI.Widget
 */
BI.DetailTablePopupSelectData = BI.inherit(BI.Widget, {
    ...
    _init: function () {
        BI.DetailTablePopupSelectData.superclass._init.apply(this, arguments);
        ...
        if (BI.isNotEmptyArray(relationTables)) {
            ...
            BI.each(relationTables, function (i, rtId) {
                relationTablesStructure.push({
                    id: rtId,
                    pId: BI.DetailTablePopupSelectData.RELATION_TABLE,
...
$.shortcut("bi.detail_table_popup_select_data", BI.DetailTablePopupSelectData);