/**
 * @class BI.DetailSelectCalculationTargetLevel0Button
 * @extends BI.Single
 */
BI.DetailSelectCalculationTargetLevel0Button = BI.inherit(BI.BasicButton, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.DetailSelectCalculationTargetLevel0Button.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-select-calc-data-level0-button",
            trigger: "mousedown",
            hgap: 0,
            layer: 0,
            lgap: 0,
    ...
    _init: function () {
        BI.DetailSelectCalculationTargetLevel0Button.superclass._init.apply(this, arguments);
    ...
    doClick: function () {
        BI.DetailSelectCalculationTargetLevel0Button.superclass.doClick.apply(this, arguments);
        if (this.isValid()) {
            this.fireEvent(BI.DetailSelectCalculationTargetLevel0Button.EVENT_CHANGE, this.getValue(), this);
        }
    },

    isSelected: function(){
        return BI.DetailSelectCalculationTargetLevel0Button.superclass.isSelected.apply(this, arguments);
    },


    setSelected: function (b) {
        BI.DetailSelectCalculationTargetLevel0Button.superclass.setSelected.apply(this, arguments);
...
BI.DetailSelectCalculationTargetLevel0Button.EVENT_CHANGE = "EVENT_CHANGE";
$.shortcut("bi.detail_select_calculation_target_level0_button", BI.DetailSelectCalculationTargetLevel0Button);