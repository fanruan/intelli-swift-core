 ...
 * @class BI.MapRegionsManager
 * @extends BI.RegionsManager
 */
BI.MapRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.MapRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-map-regions-manager",
    ...
    _init: function () {
        BI.MapRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createTarget2RegionHeader: function () {
        ...
        var header = BI.createWidget({
            type: "bi.calculate_target_region_header",
            height: 26,
            titleName: BI.i18nText("BI-Region_Suspension_Target"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.map_regions_manager', BI.MapRegionsManager);