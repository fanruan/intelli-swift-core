 ...
 * @class BI.AbstractTreeSelectDataNode
 * @extends BI.Widget
 */
BI.AbstractTreeSelectDataNode = BI.inherit(BI.Widget, {
    _defaultConfig: function () {
        return BI.extend(BI.AbstractTreeSelectDataNode.superclass._defaultConfig.apply(this, arguments), {
            id: "",
            wId: "",
            pId: "",
            open: false,
    ...
    _init: function () {
        BI.AbstractTreeSelectDataNode.superclass._init.apply(this, arguments);
                    ...
                    if (BI.isNotNull(item.group)) {
                        switch (item.group.type) {
                            ...
                            case BICst.GROUP.YMD:
                                ...
                                break;
                            case BICst.GROUP.S:
                                name += "(" + BI.i18nText("BI-Base_Quarter") + ")";
                                break;
                        }
                    }
                    vals.push(name);
    ...
    setEnable: function (b) {
        BI.AbstractTreeSelectDataNode.superclass.setEnable.apply(this, arguments);
