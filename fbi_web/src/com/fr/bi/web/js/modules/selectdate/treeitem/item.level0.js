 ...
 * @class BI.SelectDateLevel0Item
 * @extends BI.Single
 */
BI.SelectDateLevel0Item = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.SelectDateLevel0Item.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-select-date-level0-item bi-select-data-level0-item",
            wId: "",
            height: 25,
            hgap: 0,
    ...
    _init: function () {
        BI.SelectDateLevel0Item.superclass._init.apply(this, arguments);
...
$.shortcut("bi.select_date_level0_item", BI.SelectDateLevel0Item);