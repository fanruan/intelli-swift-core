/**
 * Created by windy on 2016/9/12.
 */
BI.SubPointMapRegion = BI.inherit(BI.Widget, {
    constants: {
        TITLE_ICON_HEIGHT: 20,
        TITLE_ICON_WIDTH: 20,
        REGION_HEIGHT_NORMAL: 25,
        REGION_DIMENSION_GAP: 5,
        REGION_DIMENSION_LEFT_GAP: 35,
        POINT_REGION: 10000,
        LNG_REGION: 10001,
        LAT_REGION: 10002
    },
    ...
    _defaultConfig: function () {
        return BI.extend(BI.SubPointMapRegion.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-sub-point-map-region",
            wId: ""
        });
    },

    _getRegionNameByRegionType: function(regionType){
        var c = this.constants;
        switch (BI.parseInt(regionType)){
            case c.POINT_REGION:
                return BI.i18nText("BI-Name_Title");
            case c.LNG_REGION:
                return BI.i18nText("BI-Lng");
            case c.LAT_REGION:
                return BI.i18nText("BI-Lat");
        }
    },

    _init: function () {
        BI.SubPointMapRegion.superclass._init.apply(this, arguments);
        ...
        this.sinlgeRegion.element.droppable({
            ...
            drop: function (event, ui) {
                ...
                if (data.length > 0) {
                    self.fireEvent(BI.SubPointMapRegion.EVENT_CHANGE);
                }
        ...
        var regionName = BI.createWidget({
            type: "bi.label",
            lgap: this.constants.REGION_DIMENSION_GAP,
            text: this._getRegionNameByRegionType(o.regionType)
        });
...
BI.SubPointMapRegion.EVENT_CHANGE = "EVENT_CHANGE";
$.shortcut("bi.sub_point_map_region", BI.SubPointMapRegion);