 ...
 * @class BI.ScatterRegionsManager
 * @extends BI.RegionsManager
 */
BI.ScatterRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.ScatterRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-scatter-regions-manager",
    ...
    _init: function () {
        BI.ScatterRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createTarget1RegionHeader: function () {
        ...
        var header = BI.createWidget({
            ...
            height: 26,
            titleName: BI.i18nText("BI-Y_Value_Axis"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
    ...
    _createTarget2RegionHeader: function () {
        ...
        var header = BI.createWidget({
            type: "bi.calculate_target_region_header",
            height: 26,
            titleName: BI.i18nText("BI-X_Value_Axis"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.scatter_regions_manager', BI.ScatterRegionsManager);