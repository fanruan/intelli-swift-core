 ...
 * @class BI.AdaptiveDetailTable
 * @extends BI.Widget
 */
BI.AdaptiveDetailTable = BI.inherit(BI.Widget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AdaptiveDetailTable.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-adaptive-detail-table",
            el: {
    ...
    _init: function () {
        BI.AdaptiveDetailTable.superclass._init.apply(this, arguments);
    ...
    setWidth: function (width) {
        BI.AdaptiveDetailTable.superclass.setWidth.apply(this, arguments);
        this.table.setWidth(width);
    },

    setHeight: function (height) {
        BI.AdaptiveDetailTable.superclass.setHeight.apply(this, arguments);
    ...
    attr: function (key, value) {
        var v = BI.AdaptiveDetailTable.superclass.attr.apply(this, arguments);
        if (key === "freezeCols") {
            return v;
        }
    ...
    destroy: function () {
        this.table.destroy();
        BI.AdaptiveDetailTable.superclass.destroy.apply(this, arguments);
    }
});
$.shortcut('bi.adaptive_detail_table', BI.AdaptiveDetailTable);