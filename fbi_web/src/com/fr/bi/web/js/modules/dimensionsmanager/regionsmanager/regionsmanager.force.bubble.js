 ...
 * @class BI.ForceBubbleRegionsManager
 * @extends BI.RegionsManager
 */
BI.ForceBubbleRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.ForceBubbleRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-force-bubble-regions-manager",
    ...
    _init: function () {
        BI.ForceBubbleRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.force_bubble_regions_manager', BI.ForceBubbleRegionsManager);