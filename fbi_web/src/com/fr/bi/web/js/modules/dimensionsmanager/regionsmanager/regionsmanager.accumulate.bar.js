 ...
 * @class BI.AccumulateBarRegionsManager
 * @extends BI.RegionsManager
 */
BI.AccumulateBarRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AccumulateBarRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-accumulate-bar-regions-manager",
    ...
    _init: function () {
        BI.AccumulateBarRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.accumulate_bar_regions_manager', BI.AccumulateBarRegionsManager);