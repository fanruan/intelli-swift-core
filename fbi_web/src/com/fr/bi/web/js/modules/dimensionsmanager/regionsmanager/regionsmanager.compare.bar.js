 ...
 * @class BI.CompareBarRegionsManager
 * @extends BI.RegionsManager
 */
BI.CompareBarRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.CompareBarRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-compare-bar-regions-manager",
    ...
    _init: function () {
        BI.CompareBarRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createTarget1RegionHeader: function () {
        ...
        var header = BI.createWidget({
            ...
            height: 26,
            titleName: BI.i18nText("BI-Value_Axis_One"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
    ...
    _createTarget2RegionHeader: function () {
        ...
        var header = BI.createWidget({
            type: "bi.calculate_target_region_header",
            height: 26,
            titleName: BI.i18nText("BI-Value_Axis_Two"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.compare_bar_regions_manager', BI.CompareBarRegionsManager);