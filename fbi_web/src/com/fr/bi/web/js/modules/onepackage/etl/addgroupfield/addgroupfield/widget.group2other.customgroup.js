...
BI.CustomGroupGroup2Other = BI.inherit(BI.Widget, {
    ...
    populate: function (ungroup2Other, ungroup2OtherName, groupNames) {
        if (ungroup2Other === BICst.CUSTOM_GROUP.UNGROUP2OTHER.SELECTED) {
            ...
            if(BI.contains(groupNames, BI.i18nText("BI-Basic_Others"))){
                this.editor.setValue(BI.i18nText("BI-Basic_Others-One"));
            }
...
$.shortcut("bi.etl_add_group_field_custom_group_group2other", BI.CustomGroupGroup2Other);