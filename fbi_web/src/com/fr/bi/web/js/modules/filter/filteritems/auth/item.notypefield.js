/**
 * @class BI.AuthorityNoTypeFieldFilterItem
 * @extend BI.AbstractFilterItem
 * 维度过滤——待确定字段类型过滤条件
 */

BI.AuthorityNoTypeFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function(){
        return BI.extend(BI.AuthorityNoTypeFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-authority-no-type-field-item",
            afterValueChange: BI.emptyFn
        })
    },

    _init: function(){
        BI.AuthorityNoTypeFieldFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditionsNoType: function () {
        ...
        selectFieldPane.on(BI.AuthoritySelectData.EVENT_CONFIRM, function (v) {
    ...
    _onTypeSelected: function (v) {
        var self = this, o = this.options;
        var filterItem = BI.AuthorityFilterItemFactory.createFilterItemByFieldType(v.field_type);
...
$.shortcut("bi.authority_no_type_field_filter_item", BI.AuthorityNoTypeFieldFilterItem);