 ...
 * @class BI.BarRegionsManager
 * @extends BI.RegionsManager
 */
BI.BarRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.BarRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-bar-regions-manager",
    ...
    _init: function () {
        BI.BarRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.bar_regions_manager', BI.BarRegionsManager);