BI.NumberIntervalCustomGroupOther = BI.inherit(BI.Widget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.NumberIntervalCustomGroupOther.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-number-custom-group-other"
        })
    },
    _init: function () {
        var self = this, o = this.options;
        BI.NumberIntervalCustomGroupOther.superclass._init.apply(this, arguments);
    ...
    setValue:function(v){
        ...
        this.editor.setValue(BI.isNotNull(v) ? v : BI.i18nText("BI-Base_Others"));
...
$.shortcut("bi.number_custom_group_other", BI.NumberIntervalCustomGroupOther);