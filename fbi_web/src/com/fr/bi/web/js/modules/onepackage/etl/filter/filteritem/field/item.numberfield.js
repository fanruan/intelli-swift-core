/**
 * @class BI.ConfTargetNumberFieldFilterItem
 * @extend BI.AbstractFilterItem
 * 指标过滤——数值字段类型过滤条件
 */
BI.ConfTargetNumberFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
...
BI.ConfTargetNumberFieldFilterItem.EVENT_CHANGE = "EVENT_CHANGE";
$.shortcut("bi.conf_target_number_field_filter_item", BI.ConfTargetNumberFieldFilterItem);