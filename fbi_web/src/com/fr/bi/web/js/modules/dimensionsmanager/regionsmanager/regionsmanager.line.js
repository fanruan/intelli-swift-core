 ...
 * @class BI.LineRegionsManager
 * @extends BI.RegionsManager
 */
BI.LineRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.LineRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-line-regions-manager",
    ...
    _init: function () {
        BI.LineRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.line_regions_manager', BI.LineRegionsManager);