 ...
 * @class BI.PercentAccumulateAxisRegionsManager
 * @extends BI.RegionsManager
 */
BI.PercentAccumulateAxisRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.PercentAccumulateAxisRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-percent-accumulate-axis-regions-manager",
    ...
    _init: function () {
        BI.PercentAccumulateAxisRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.percent_accumulate_axis_regions_manager', BI.PercentAccumulateAxisRegionsManager);