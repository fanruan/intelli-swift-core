 ...
 * @class BI.SequenceDetailTableListNumber
 * @extends BI.Widget
 */
BI.SequenceDetailTableListNumber = BI.inherit(BI.Widget, {

    _defaultConfig: function () {
        return BI.extend(BI.SequenceDetailTableListNumber.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-sequence-detail-table-list-number",
            isNeedFreeze: false,
            scrollTop: 0,
    ...
    _init: function () {
        BI.SequenceDetailTableListNumber.superclass._init.apply(this, arguments);
        ...
        this.header = BI.createWidget({
            ...
            cls: "sequence-detail-table-title-cell",
        ...
        for (var i = start, cnt = 0; i <= end && i < o.items.length; i++, cnt++) {
            ...
            if (index > -1) {
                ...
                var child = BI.createWidget(BI.extend({
                    type: "bi.table_style_cell",
                    cls: "sequence-detail-table-number-cell",
                    width: 60,
                    height: o.rowSize,
                    text: this.start + i,
...
$.shortcut('bi.sequence_detail_table_list_number', BI.SequenceDetailTableListNumber);