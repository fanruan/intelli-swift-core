...
BI.AddDataLink = BI.inherit(BI.BarPopoverSection, {
    ...
    rebuildCenter: function (center) {
        ...
        var driverWrapper = this._createItemWrap( BI.i18nText("BI-Basic_Driver"), driverCombo);
        ...
        var passwordWrapper = this._createItemWrap(BI.i18nText("BI-Basic_Password"), password);
