 ...
 * @class BI.HeatMapRegionsManager
 * @extends BI.RegionsManager
 */
BI.HeatMapRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.HeatMapRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-heat-map-regions-manager",
    ...
    _init: function () {
        BI.HeatMapRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createDimension2RegionHeader: function () {
        ...
        var header = BI.createWidget({
            type: "bi.region_header",
            height: 26,
            titleName: BI.i18nText("BI-Name_Title"),
    ...
    _createTarget1RegionHeader: function () {
        ...
        var header = BI.createWidget({
            ...
            height: 26,
            titleName: BI.i18nText("BI-Region_Target"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.heat_map_regions_manager', BI.HeatMapRegionsManager);