 ...
 * @class BI.AreaRegionsManager
 * @extends BI.RegionsManager
 */
BI.AreaRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AreaRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-area-regions-manager",
    ...
    _init: function () {
        BI.AreaRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.area_regions_manager', BI.AreaRegionsManager);