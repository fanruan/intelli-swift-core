 ...
 * @extends BI.Model
 */
BI.DetailTablePopupModel = BI.inherit(BI.Model, {
    ...
    destroy: function () {
        Data.SharingPool.remove(BI.DetailTablePopup.SHARING_POOL_KEY);
        BI.DetailTablePopupModel.superclass.destroy.apply(this, arguments);
    }
});