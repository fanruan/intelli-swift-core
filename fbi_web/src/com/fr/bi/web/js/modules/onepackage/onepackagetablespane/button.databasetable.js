/**
 * @class BI.DatabaseTableButton
 * @extend BI.Widget
 * 表（数据库表、etl表、excel）
 */
BI.DatabaseTableButton = BI.inherit(BI.BasicButton, {
    ...
    _defaultConfig: function(){
        var conf = BI.DatabaseTableButton.superclass._defaultConfig.apply(this, arguments);
    ...
    _init: function(){
        BI.DatabaseTableButton.superclass._init.apply(this, arguments);
    ...
    setSelected: function(){
        BI.DatabaseTableButton.superclass.setSelected.apply(this, arguments);
        if (this.isSelected()) {
...
$.shortcut("bi.database_table_button", BI.DatabaseTableButton);