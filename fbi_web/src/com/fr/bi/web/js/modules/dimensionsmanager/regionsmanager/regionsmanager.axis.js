 ...
 * @class BI.AxisRegionsManager
 * @extends BI.RegionsManager
 */
BI.AxisRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AxisRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-axis-regions-manager",
    ...
    _init: function () {
        BI.AxisRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.axis_regions_manager', BI.AxisRegionsManager);