 ...
 * @class BI.BubbleRegionsManager
 * @extends BI.RegionsManager
 */
BI.BubbleRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.BubbleRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-bubble-regions-manager",
    ...
    _init: function () {
        BI.BubbleRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.bubble_regions_manager', BI.BubbleRegionsManager);