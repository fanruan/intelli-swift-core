 ...
 * @class BI.GisMapRegionsManager
 * @extends BI.RegionsManager
 */
BI.GisMapRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.GisMapRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-gis-map-regions-manager",
    ...
    _init: function () {
        BI.GisMapRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.gis_map_regions_manager', BI.GisMapRegionsManager);