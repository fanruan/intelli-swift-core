 ...
 * @class BI.FallAxisRegionsManager
 * @extends BI.RegionsManager
 */
BI.FallAxisRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.FallAxisRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-fall-axis-regions-manager",
    ...
    _init: function () {
        BI.FallAxisRegionsManager.superclass._init.apply(this, arguments);
    ...
    _createTargetRegionHeader: function () {
        ...
        var header = BI.createWidget({
            ...
            height: 26,
            titleName: BI.i18nText("BI-Value_Axis"),
            dimensionCreator: o.dimensionCreator,
            wId: o.wId,
...
$.shortcut('bi.fall_axis_regions_manager', BI.FallAxisRegionsManager);