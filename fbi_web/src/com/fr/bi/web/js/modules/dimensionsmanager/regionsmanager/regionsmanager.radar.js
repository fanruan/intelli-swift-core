 ...
 * @class BI.RadarRegionsManager
 * @extends BI.RegionsManager
 */
BI.RadarRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.RadarRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-radar-regions-manager",
    ...
    _init: function () {
        BI.RadarRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.radar_regions_manager', BI.RadarRegionsManager);