 ...
 * @class BI.TreeRegionsManager
 * @extends BI.RegionsManager
 */
BI.TreeRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.TreeRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-tree-regions-manager",
    ...
    _init: function () {
        BI.TreeRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.tree_regions_manager', BI.TreeRegionsManager);