 ...
 * created by young
 */
BI.AuthorityDateFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AuthorityDateFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-authority-date-field-item",
            afterValueChange: BI.emptyFn
        })
    },

    _init: function () {
        BI.AuthorityDateFieldFilterItem.superclass._init.apply(this, arguments);
...
$.shortcut("bi.authority_date_field_filter_item", BI.AuthorityDateFieldFilterItem);