 ...
 */
BI.FieldRelationSettingWithPreviewPopupModel = BI.inherit(FR.OB, {
    _defaultConfig: function () {
        return BI.extend(BI.FieldRelationSettingWithPreviewPopupModel.superclass._defaultConfig.apply(this, arguments), {
            wid: ""
        })
    },
    _init: function () {
        BI.FieldRelationSettingWithPreviewPopupModel.superclass._init.apply(this, arguments);
        this._initData();
    },
