            ...
            try {
                ...
                if (BI.Utils.getWSMinimalistByID(o.wId) && BI.ChartDisplay.MINIMALIST_WIDGET.contains(type)) {
                    op = BI.extend(options, {
                        ...
                        leftYReverse: BI.Utils.getWSLeftYReverseByID(o.wId),
                        rightYRevers: BI.Utils.getWSRightYReverseByID(o.wId),
                    ...
                    op = BI.extend(options, {
                        ...
                        rightYCustomScale: BI.Utils.getWSChartLeftYCustomScale(o.wId),
                        ...
                        right2YShowLabel: BI.Utils.getWSRightY2ShowLabelByID(o.wId),
