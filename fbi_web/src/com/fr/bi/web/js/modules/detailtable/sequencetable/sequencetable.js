 ...
 * @class BI.SequenceDetailTable
 * @extends BI.Widget
 */
BI.SequenceDetailTable = BI.inherit(BI.Widget, {

    _defaultConfig: function () {
        return BI.extend(BI.SequenceDetailTable.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-sequence-detail-table",
            el: {
    ...
    _init: function () {
        BI.SequenceDetailTable.superclass._init.apply(this, arguments);
    ...
    attr: function () {
        BI.SequenceDetailTable.superclass.attr.apply(this, arguments);
    ...
    destroy: function () {
        this.table.destroy();
        BI.SequenceDetailTable.superclass.destroy.apply(this, arguments);
    }
});
$.shortcut('bi.sequence_detail_table', BI.SequenceDetailTable);