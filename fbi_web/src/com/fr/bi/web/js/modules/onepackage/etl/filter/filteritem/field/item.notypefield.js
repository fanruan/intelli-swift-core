/**
 * @class BI.ConfTargetNoTypeFieldFilterItem
 * @extend BI.AbstractFilterItem
 * 指标过滤——待确定字段类型过滤条件
 */
BI.ConfTargetNoTypeFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.ConfTargetNoTypeFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.ConfTargetNoTypeFieldFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditionsNoType: function () {
        var self = this, o = this.options;
        this.selectFieldPane = BI.createWidget({
            type: "bi.conf_filter_select_single_field",
            table: o.table
        });
        ...
        this.selectFieldPane.on(BI.ConfFilterSelectSingleField.EVENT_CLICK_ITEM, function (v) {
    ...
    _onTypeSelected: function (v) {
        var fieldType = v.field.field_type;
        var self = this, o = this.options;
        var filterItem = BI.ConfFilterItemFactory.createFilterItemByFieldType(fieldType);
...
$.shortcut("bi.conf_target_no_type_field_filter_item", BI.ConfTargetNoTypeFieldFilterItem);