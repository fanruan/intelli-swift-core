 ...
 * @class BI.PieRegionsManager
 * @extends BI.RegionsManager
 */
BI.PieRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.PieRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-pie-regions-manager",
    ...
    _init: function () {
        BI.PieRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.pie_regions_manager', BI.PieRegionsManager);