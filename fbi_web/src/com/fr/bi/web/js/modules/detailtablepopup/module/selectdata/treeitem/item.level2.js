 ...
 * 相关表的日期字段items
 */
BI.DetailTablePopupSelectDataLevel2Item = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.DetailTablePopupSelectDataLevel2Item.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.DetailTablePopupSelectDataLevel2Item.superclass._init.apply(this, arguments);
...
$.shortcut("bi.detail_table_popup_select_data_level2_item", BI.DetailTablePopupSelectDataLevel2Item);