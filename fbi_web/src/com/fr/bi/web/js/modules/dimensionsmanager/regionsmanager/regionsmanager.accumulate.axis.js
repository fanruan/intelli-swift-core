 ...
 * @class BI.AccumulateAxisRegionsManager
 * @extends BI.RegionsManager
 */
BI.AccumulateAxisRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.AccumulateAxisRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-accumulate-axis-regions-manager",
    ...
    _init: function () {
        BI.AccumulateAxisRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.accumulate_axis_regions_manager', BI.AccumulateAxisRegionsManager);