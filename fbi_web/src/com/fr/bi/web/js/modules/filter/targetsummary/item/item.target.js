/**
 * Created by roy on 16/6/29.
 */
BI.TargetTableFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.TargetTableFilterItem.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-analysis-target-table-filter-item",
            afterValueChange: BI.emptyFn
        })
    },

    _init: function () {
        BI.TargetTableFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditions: function () {
        ...
        this.dId = o.dId;
        var dimensionName = BI.Utils.getDimensionNameByID(this.dId);
...
$.shortcut("bi.target_table_filter_item", BI.TargetTableFilterItem);