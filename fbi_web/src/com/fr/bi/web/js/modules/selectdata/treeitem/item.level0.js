 ...
 * @extends BI.Single
 */
BI.DetailSelectDataLevel0Item = BI.inherit(BI.Single, {
    ...
    _init: function () {
        BI.DetailSelectDataLevel0Item.superclass._init.apply(this, arguments);
...
$.shortcut("bi.detail_select_data_level0_item", BI.DetailSelectDataLevel0Item);