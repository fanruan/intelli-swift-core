...
BI.CustomGroup = BI.inherit(BI.Widget, {
    ...
    _init: function () {
        ...
        this.chosenPane = BI.createWidget({
            type: "bi.etl_group_custom_group_field_pane",
        ...
        this.combo = BI.createWidget({
            type: "bi.etl_group_custom_group_combo",
        ...
        this.fieldPane = BI.createWidget({
            type: "bi.etl_group_custom_group_all_fields_pane",
        ...
        this.searchPane = BI.createWidget({
            type: "bi.etl_group_custom_group_searcher_pane",
        ...
        this.search = BI.createWidget({
            type: "bi.etl_group_custom_group_search",
        ...
        this.bottom = BI.createWidget({
            type: "bi.etl_group_custom_group_group2other",
...
$.shortcut("bi.etl_group_custom_group", BI.CustomGroup);