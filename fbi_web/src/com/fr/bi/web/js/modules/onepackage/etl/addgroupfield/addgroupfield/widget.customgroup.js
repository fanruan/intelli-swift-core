...
BI.CustomGroup = BI.inherit(BI.Widget, {
    ...
    _init: function () {
        ...
        this.combo = BI.createWidget({
            type: "bi.etl_add_group_field_custom_group_combo",
        ...
        this.searchPane = BI.createWidget({
            type: "bi.etl_add_group_field_custom_group_searcher_pane",
        ...
        this.search = BI.createWidget({
            type: "bi.etl_add_group_field_custom_group_search",
        ...
        this.bottom = BI.createWidget({
            type: "bi.etl_add_group_field_custom_group_group2other",
...
$.shortcut("bi.etl_add_group_field_custom_group", BI.CustomGroup);