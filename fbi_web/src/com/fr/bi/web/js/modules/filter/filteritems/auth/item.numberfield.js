 ...
 * create by young
 */
BI.AuthorityNumberFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AuthorityNumberFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.AuthorityNumberFieldFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditions: function () {
        ...
        var fieldName = BI.Utils.getTableNameByFieldId4Conf(this.fieldId) + "." +
            BI.Utils.getFieldNameById4Conf(this.fieldId);
        ...
        this.filterType = BI.createWidget({
            ...
            height: this._constant.BUTTON_HEIGHT,
            items: BICst.AUTHORITY_FILTER_NUMBER_COMBO
        });
...
$.shortcut("bi.authority_number_field_filter_item", BI.AuthorityNumberFieldFilterItem);