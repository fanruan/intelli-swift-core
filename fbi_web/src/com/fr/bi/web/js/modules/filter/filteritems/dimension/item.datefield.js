/**
 * @class BI.DimensionDateFieldFilterItem

 * @extend BI.AbstractFilterItem
 * 维度过滤——时间字段日期类型过滤条件

 */
BI.DimensionDateFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.DimensionDateFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
...
$.shortcut("bi.dimension_date_field_filter_item", BI.DimensionDateFieldFilterItem);