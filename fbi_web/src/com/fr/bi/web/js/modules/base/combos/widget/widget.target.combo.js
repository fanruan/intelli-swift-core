 ...
 * 指标下拉
 */
BI.TargetCombo = BI.inherit(BI.Widget, {
    ...
    _init: function(){
        ...
        this.combo.on(BI.DownListCombo.EVENT_BEFORE_POPUPVIEW,function(){
            var selectedValue = self._createValueByGroupAndChartType(BI.Utils.getDimensionGroupByID(o.dId),BI.Utils.getDimensionStyleOfChartByID(o.dId));
...
BI.TargetCombo.EVENT_CHANGE = "EVENT_CHANGE";
