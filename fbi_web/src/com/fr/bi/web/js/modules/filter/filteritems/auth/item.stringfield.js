 ...
 * create by young
 */
BI.AuthorityStringFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.AuthorityStringFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.AuthorityStringFieldFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditions: function () {
        ...
        this.filterType = BI.createWidget({
            ...
            height: this._constant.BUTTON_HEIGHT,
            items: BICst.AUTHORITY_FILTER_STRING_COMBO
        });
    ...
    _createTargetStringBelongCombo: function (initData) {
        var self = this, o = this.options;
        this.filterWidget = BI.createWidget({
            type: "bi.authority_select_field_data_combo",
            field_id: o._src.field_id,
            width: 200,
            height: this._constant.BUTTON_HEIGHT
        });
...
$.shortcut("bi.authority_string_field_filter_item", BI.AuthorityStringFieldFilterItem);