/**
 * @class BI.DimensionNoTypeFieldFilterItem
 * @extend BI.AbstractFilterItem
 * 维度过滤——待确定字段类型过滤条件
 */

BI.DimensionNoTypeFieldFilterItem = BI.inherit(BI.AbstractFilterItem, {
    ...
    _defaultConfig: function(){
        return BI.extend(BI.DimensionNoTypeFieldFilterItem.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-dimension-no-type-field-item",
            afterValueChange: BI.emptyFn
        })
    },

    _init: function(){
        BI.DimensionNoTypeFieldFilterItem.superclass._init.apply(this, arguments);
    ...
    _buildConditionsNoType: function(){
        ...
        selectFieldPane.on(BI.DimensionFilterSelectField.EVENT_CLICK_ITEM, function(v){
    ...
    _onTypeSelected: function (v) {
        ...
        var self = this, o = this.options;
        var filterItem = BI.DimensionFilterItemFactory.createFilterItemByFieldType(fieldType);
...
$.shortcut("bi.dimension_no_type_field_filter_item", BI.DimensionNoTypeFieldFilterItem);