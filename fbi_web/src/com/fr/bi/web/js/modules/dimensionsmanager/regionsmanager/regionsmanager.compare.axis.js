 ...
 * @class BI.CompareAxisRegionsManager
 * @extends BI.RegionsManager
 */
BI.CompareAxisRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.CompareAxisRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-compare-axis-regions-manager",
    ...
    _init: function () {
        BI.CompareAxisRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.compare_axis_regions_manager', BI.CompareAxisRegionsManager);