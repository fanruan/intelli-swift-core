...
BI.MultiAxisChartSetting = BI.inherit(BI.AbstractChartSetting, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.MultiAxisChartSetting.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-charts-setting bi-multi-axis-chart"
        })
    },
    ...
    _init: function () {
        ...
        BI.createWidget({
            ...
            items: [this.tableStyle, this.lYAxis, this.rYAxis, this.rYAxis2, this.xAxis, this.showElement, this.otherAttr, modelChange],
            hgap: 10
        })
    },
