...
BI.MultiAxisChartSetting = BI.inherit(BI.AbstractChartSetting, {
    ...
    populate: function () {
        ...
        this.rightY2NumberFormat.setValue(BI.Utils.getWSRightYAxis2StyleByID(wId));
        this.rightY2NumberLevel.setValue(BI.Utils.getWSRightYAxis2NumLevelByID(wId));
        this.rightY2Unit.setValue(BI.Utils.getWSRightYAxis2UnitByID(wId));
        this.rightY2ShowTitle.setSelected(BI.Utils.getWSShowRightYAxis2TitleByID(wId));
        this.rightY2Title.setValue(titleRY2);
        this.rightY2Reverse.setSelected(BI.Utils.getWSRightYAxis2ReversedByID(wId));
        ...
        this.rightY2Separator.setSelected(BI.Utils.getWSRight2NumberSeparatorsByID(wId));
        this.rightY2ShowLabel.setSelected(BI.Utils.getWSShowR2ValueAxisLabelByID(wId));
        this.rightY2LabelStyle.setValue(BI.Utils.getWSR2ValueAxisLabelSettingByID(wId));
        this.rightY2LineColor.setValue(BI.Utils.getWSR2ValueAxisLineColorByID(wId));
        this.rightY2TitleStyle.setValue(BI.Utils.getWSRight2TitleStyleByID(wId));
