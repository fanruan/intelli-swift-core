...
BI.CustomgroupGroupExpander = BI.inherit(BI.Widget, {
    _defaultConfig: function () {
        return BI.extend(BI.CustomgroupGroupExpander.superclass._defaultConfig.apply(this, arguments), {
            ...
            item: {},
            title: "",
            nodeType: "bi.etl_add_group_field_arrow_group_node_delete"
            ...
            BI.each(item.content, function (i_in, item_in) {
                ...
                if (!findField) {
                    var fieldButton = BI.createWidget({
                        type: "bi.etl_add_group_field_custom_group_field_button",
...
$.shortcut("bi.etl_add_group_field_custom_group_group_expander", BI.CustomgroupGroupExpander);