 ...
 * @class BI.DetailTablePopupSelectDataLevel1Item
 * @extends BI.Single
 */
BI.DetailTablePopupSelectDataLevel1Item = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.DetailTablePopupSelectDataLevel1Item.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-detail-table-popup-select-data-level1-item bi-select-data-level1-item",
            height: 25,
    ...
    _init: function () {
        BI.DetailTablePopupSelectDataLevel1Item.superclass._init.apply(this, arguments);
        var self = this, o = this.options;
        this.button = BI.createWidget({
            type: "bi.blank_icon_text_item",
            trigger: "mousedown",
            cls: "detail-table-popup-select-date-level1-item-button " + this._getFieldClass(o.fieldType),
            text: o.text,
            value: o.value,
            blankWidth: 35,
            height: 25,
...
$.shortcut("bi.detail_table_popup_select_data_level1_item", BI.DetailTablePopupSelectDataLevel1Item);