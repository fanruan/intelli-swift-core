...
BI.DetailSelectDimensionPane = BI.inherit(BI.Widget, {
    ...
    constants: {
        ...
        CONTROL_TYPE: [BICst.WIDGET.STRING, BICst.WIDGET.STRING_LIST, BICst.WIDGET.NUMBER, BICst.WIDGET.SINGLE_SLIDER, BICst.WIDGET.INTERVAL_SLIDER, BICst.WIDGET.DATE, BICst.WIDGET.MONTH,
            BICst.WIDGET.QUARTER, BICst.WIDGET.TREE, BICst.WIDGET.TREE_LIST, BICst.WIDGET.LIST_LABEL, BICst.WIDGET.TREE_LABEL, BICst.WIDGET.YEAR, BICst.WIDGET.YMD, BICst.WIDGET.GENERAL_QUERY,
