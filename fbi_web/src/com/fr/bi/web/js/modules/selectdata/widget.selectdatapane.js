        ...
        if (BI.isNotEmptyArray(relationTables)) {
            ...
            BI.each(relationTables, function (i, rtId) {
                relationTablesStructure.push({
                    id: rtId,
                    pId: BI.DetailSelectDataPane.RELATION_TABLE,
...
BI.extend(BI.DetailSelectDataPane, {
