 ...
 * @class BI.FunnelRegionsManager
 * @extends BI.RegionsManager
 */
BI.FunnelRegionsManager = BI.inherit(BI.RegionsManager, {

    _defaultConfig: function () {
        return BI.extend(BI.FunnelRegionsManager.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-funnel-regions-manager",
    ...
    _init: function () {
        BI.FunnelRegionsManager.superclass._init.apply(this, arguments);
...
$.shortcut('bi.funnel_regions_manager', BI.FunnelRegionsManager);