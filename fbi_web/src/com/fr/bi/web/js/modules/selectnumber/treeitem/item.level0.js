 ...
 * @class BI.SelectNumberLevel0Item
 * @extends BI.Single
 */
BI.SelectNumberLevel0Item = BI.inherit(BI.Single, {
    _defaultConfig: function () {
        return BI.extend(BI.SelectNumberLevel0Item.superclass._defaultConfig.apply(this, arguments), {
            extraCls: "bi-select-number-level0-item bi-select-data-level0-item",
            wId: "",
            height: 25,
            hgap: 0,
    ...
    _init: function () {
        BI.SelectNumberLevel0Item.superclass._init.apply(this, arguments);
...
$.shortcut("bi.select_number_level0_item", BI.SelectNumberLevel0Item);