/**
 * @class BI.ParetoChartsSetting
 * @extends BI.Widget
 * 帕累托图
 */
BI.ParetoChartsSetting = BI.inherit(BI.AbstractChartSetting, {
    ...
    _init: function () {
        BI.ParetoChartsSetting.superclass._init.apply(this, arguments);
        ...
        this.showName.on(BI.Controller.EVENT_CHANGE, function () {
            ...
            self.fireEvent(BI.ParetoChartsSetting.EVENT_CHANGE);
        });
