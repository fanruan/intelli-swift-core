 ...
 * @extends BI.Widget
 */
BI.FixTable = BI.inherit(BI.Widget, {
                ...
                if (j < BI.size(tds) - 1) {
                    td.resizable({
                        ...
                        start: function (event, ui) {
                            ...
                            self.fireEvent(BI.FixTable.EVENT_TABLE_BEFORE_COLUMN_RESIZE);
                        },
                        resize: function (e, ui) {
                            var height = getHeight(ui.size, ui.position);
                            ...
                            //self.setColumnSize(o.columnSize);
                            self.fireEvent(BI.FixTable.EVENT_TABLE_COLUMN_RESIZE);
                            e.stopPropagation();
                            //return false;
                        },
                        stop: function (e, ui) {
                            ...
                            self.setColumnSize(o.columnSize);
                            self.fireEvent(BI.FixTable.EVENT_TABLE_AFTER_COLUMN_RESIZE);
                        }
                    })
                }
            })
    ...
    setVerticalScroll: function (scrollTop) {
        ...
        if (o.isNeedFreeze) {
            if (this.scrollBottomRight.element[0].scrollTop !== scrollTop) {
                ...
                if (!this._scrollBounce) {
                    this._scrollBounce = BI.debounce(BI.bind(this._scroll, this), 300);
                }
            ...
            if (this.scrollBottomLeft.element[0].scrollTop !== scrollTop) {
                ...
                if (!this._scrollBounce) {
                    this._scrollBounce = BI.bounce(BI.bind(this._scroll, this), 300);
                }
                this._scrollBounce(scrollTop);
            }
        } else {
    ...
    empty: function () {
        ...
        BI.FixTable.superclass.empty.apply(this, arguments);
    },
