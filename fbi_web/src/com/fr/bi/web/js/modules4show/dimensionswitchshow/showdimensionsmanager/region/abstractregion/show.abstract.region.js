 ...
 */
BI.ShowAbstractRegion = BI.inherit(BI.Widget, {
    _defaultConfig: function () {
        return BI.extend(BI.ShowAbstractRegion.superclass._defaultConfig.apply(this, arguments), {
    ...
    _init: function () {
        BI.ShowAbstractRegion.superclass._init.apply(this, arguments);
        ...
        this.center.element.sortable({
            ...
            update: function (event, ui) {
                self.fireEvent(BI.ShowAbstractRegion.EVENT_CHANGE);
            },
            start: function (event, ui) {
                self.fireEvent(BI.ShowAbstractRegion.EVENT_START);
            },
            stop: function (event, ui) {
                self.fireEvent(BI.ShowAbstractRegion.EVENT_STOP);
            },
...
BI.ShowAbstractRegion.EVENT_START = "EVENT_START";
BI.ShowAbstractRegion.EVENT_STOP = "EVENT_STOP";
BI.ShowAbstractRegion.EVENT_CHANGE = "EVENT_CHANGE";