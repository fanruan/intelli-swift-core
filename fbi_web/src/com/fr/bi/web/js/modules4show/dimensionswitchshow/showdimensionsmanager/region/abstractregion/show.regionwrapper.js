/**
 * Created by zcf on 2017/1/3.
 */
BI.ShowRegionWrapper = BI.inherit(BI.Widget, {
    ...
    _defaultConfig: function () {
        return BI.extend(BI.ShowRegionWrapper.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-region-wrapper",
        });
    },

    _init: function () {
        BI.ShowRegionWrapper.superclass._init.apply(this, arguments);
        ...
        this.center.element.sortable({
            ...
            update: function (event, ui) {
                self.fireEvent(BI.ShowRegionWrapper.EVENT_CHANGE);
            },
            start: function (event, ui) {
                self.fireEvent(BI.ShowRegionWrapper.EVENT_START);
            },
            stop: function (event, ui) {
                self.fireEvent(BI.ShowRegionWrapper.EVENT_STOP);
            },
...
BI.ShowRegionWrapper.EVENT_CHANGE = "ShowRegionWrapper.EVENT_CHANGE";
BI.ShowRegionWrapper.EVENT_START = "ShowRegionWrapper.EVENT_START";
BI.ShowRegionWrapper.EVENT_STOP = "ShowRegionWrapper.EVENT_STOP";