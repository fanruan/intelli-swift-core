 ...
 * @class BI.DimensionsManagerShowModel
 * @extends BI.Widget
 */
BI.DimensionsManagerShowModel = BI.inherit(BI.Widget, {

    _defaultConfig: function () {
        return BI.extend(BI.DimensionsManagerShowModel.superclass._defaultConfig.apply(this, arguments), {
            wId: ""
        });
    },

    _init: function () {
        BI.DimensionsManagerShowModel.superclass._init.apply(this, arguments);
        this.viewMap = {};
        this.populate();
    },
