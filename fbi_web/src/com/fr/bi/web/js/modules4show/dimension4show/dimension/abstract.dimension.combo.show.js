...
BI.AbstractDimensionComboShow = BI.inherit(BI.AbstractDimensionTargetComboShow, {
    ...
    _defaultConfig: function(){
        return BI.extend(BI.AbstractDimensionComboShow.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-abstract-dimension-combo"
        })
    },

    _init: function(){
        BI.AbstractDimensionComboShow.superclass._init.apply(this, arguments);
    },
