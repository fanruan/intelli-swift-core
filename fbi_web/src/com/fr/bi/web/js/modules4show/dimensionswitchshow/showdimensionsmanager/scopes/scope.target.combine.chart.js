 ...
 * @extends BI.Widget
 */
BI.ShowCombineChartTargetScope = BI.inherit(BI.Widget, {

    _defaultConfig: function () {
        return BI.extend(BI.ShowCombineChartTargetScope.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-show-combine-chart-target-scope"
        });
    },

    _init: function () {
        BI.ShowCombineChartTargetScope.superclass._init.apply(this, arguments);
        ...
        this.combo = BI.createWidget({
            ...
            items: [{
                ...
                text: BI.i18nText("BI-Accumulate_Area") + "(" + BI.i18nText("BI-Base_Polyline") + ")",
                title: BI.i18nText("BI-Accumulate_Area") + "(" + BI.i18nText("BI-Base_Polyline") + ")",
...
BI.ShowCombineChartTargetScope.EVENT_CHANGE = "CombineChartTargetScope.EVENT_CHANGE";
$.shortcut("bi.show_combine_chart_target_scope", BI.ShowCombineChartTargetScope);