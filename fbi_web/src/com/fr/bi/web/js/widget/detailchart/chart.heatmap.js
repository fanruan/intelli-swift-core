/**
 * 图表控件
 * @class BI.HeatMapChart
 * @extends BI.Widget
 */
BI.HeatMapChart = BI.inherit(BI.AbstractChart, {

    _defaultConfig: function () {
        return BI.extend(BI.HeatMapChart.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-heat-map-chart"
        })
    },

    _init: function () {
        BI.HeatMapChart.superclass._init.apply(this, arguments);
        ...
        this.combineChart.on(BI.CombineChart.EVENT_CHANGE, function (obj) {
            self.fireEvent(BI.HeatMapChart.EVENT_CHANGE, obj);
        });
    ...
    populate: function (items, options) {
        ...
        BI.each(items, function (idx, axisItems) {
            ...
            BI.each(axisItems, function () {
                type.push(BICst.WIDGET.HEAT_MAP);
            });
            types.push(type);
        });
...
BI.HeatMapChart.EVENT_CHANGE = "EVENT_CHANGE";
$.shortcut('bi.heat_map_chart', BI.HeatMapChart);