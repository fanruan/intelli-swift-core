 ...
 * @class BI.SelectNumber4RealTime
 * @extend BI.Widget
 */
BI.SelectNumber4RealTime = BI.inherit(BI.Widget, {
    _defaultConfig: function () {
        return BI.extend(BI.SelectNumber4RealTime.superclass._defaultConfig.apply(this, arguments), {
            wId: ""
        })
    },

    _init: function () {
        BI.SelectNumber4RealTime.superclass._init.apply(this, arguments);
...
$.shortcut("bi.select_number_4_realtime", BI.SelectNumber4RealTime);