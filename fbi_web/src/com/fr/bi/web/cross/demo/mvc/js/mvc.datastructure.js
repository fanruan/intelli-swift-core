        ...
        return {
            ...
            current : {
                ...
                popupConfig: {
                    id: 6,		//模板ID，同上
                    layoutData: {},		//布局数据
                    layoutStyle: 0,	//布局方式--自由/自适应，BICst.DASHBOARD_LAYOUT_ARRAY
                    widgets: {
                        "b8cb9d91f6035364": {
                            bounds: {		//位置信息
                                h: 250,
