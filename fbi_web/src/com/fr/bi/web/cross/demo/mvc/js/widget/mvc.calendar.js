CalendarView = BI.inherit(BI.View, {
    _defaultConfig: function(){
        return BI.extend(CalendarView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-mvc-calendar bi-mvc-layout"
        })
    },

    _init: function(){
        CalendarView.superclass._init.apply(this, arguments);
    },
...
CalendarModel = BI.inherit(BI.Model, {
