//combo控件
ComboView = BI.inherit(BI.View, {
    _defaultConfig: function () {
        return BI.extend(ComboView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-mvc-combo bi-mvc-layout"
        })
    },

    _init: function () {
        ComboView.superclass._init.apply(this, arguments);
    },
        ...
        var yearCombo = BI.createWidget({
            ...
            popup: {
                el: {
                    ...
                    items: BI.createItems(this.model.get("years"), {
        ...
        var multiCombo = BI.createWidget({
            ...
            popup: {
                ...
                tabs: [{
                    ...
                    onCheck: function (v) {
                        if (v) {
                            multiCombo.setValue(BI.pluck(self.model.get("years"), "value"));
                        } else {
                            multiCombo.setValue([]);
                        }
                    ...
                    isAllCheckedBySelectedValue: function (selectedValue) {
                        return selectedValue.length == self.model.get("years").length
//                        return true;
                    }
                }],
                buttons: [{
        ...
        var dynamicPopupCombo = BI.createWidget({
            ...
            popup: {
                el: {
                    items: BI.createItems(this.model.get("dynamic"), {
    ...
    _createBottom: function () {
        ...
        combo.setValue(this.model.get("years")[0].value);
        ...
        var childCombo = BI.createWidget({
            ...
            popup: {
                el: {
                    type: "bi.button_tree",
                    items: BI.createItems(this.model.get("child"), {
                        type: "bi.single_select_item",
                        height: 25,
                        handler: function (v) {
        ...
        childCombo.setValue(this.model.get("child")[0].children[0].value);
        ...
        var monthCombo = BI.createWidget({
            ...
            popup: {
                el: {
                    items: BI.createItems(this.model.get("months"), {
                        type: "bi.single_select_item",
                        cls: "button-combo",
                        handler: function (v) {
...
ComboModel = BI.inherit(BI.Model, {
    _defaultConfig: function () {
        return BI.extend(ComboModel.superclass._defaultConfig.apply(this, arguments), {
            years: [{
    ...
    _init: function () {
        ComboModel.superclass._init.apply(this, arguments);
    }
});