PanesView = BI.inherit(BI.View, {
    _defaultConfig: function () {
        return BI.extend(PanesView.superclass._defaultConfig.apply(this, arguments), {
            baseCls: "bi-mvc-panes bi-mvc-layout"
        })
    },

    _init: function () {
        PanesView.superclass._init.apply(this, arguments);
    },
    ...
    _createSearchPane: function () {
        ...
        searcher.populate(BI.createItems(BI.first(ITEMS, 20), {
    ...
    _createSearchTreePane: function () {
        ...
        searcher.populate(BI.deepClone(TREEITEMS), [{
            type: "bi.multi_select_item",
            height: 25,
            text: "这是一个完全匹配的项"
        }], "test");
    ...
    _createMultiSelectPane: function () {
        var list = BI.createWidget({
            ...
            width: 200,
            height: 100,
            items: BI.createItems(BI.first(ITEMS, 1), {
                type: "bi.multi_select_item",
                height: 25
            }),
            el: {
        ...
        BI.createWidget({
            ...
            items: [{
                ...
                popup: {
                    ...
                    el: {
                        type: "bi.button_group",
                        items: BI.createItems(BI.first(ITEMS, 20), {
                            type: "bi.multi_select_item"
                        }),
                        layouts: [{
                            type: "bi.vertical"
...
PanesModel = BI.inherit(BI.Model, {});