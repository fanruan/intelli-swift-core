...
import com.fr.swift.cloud.query.info.group.post.CalculatedFieldQueryInfo;
import com.fr.swift.cloud.query.info.group.post.FunnelPostQueryInfo;
...
import com.fr.swift.cloud.query.info.group.post.TreeAggregationQueryInfo;
import com.fr.swift.cloud.query.info.group.post.TreeFilterQueryInfo;
import com.fr.swift.cloud.query.info.group.post.TreeSortQueryInfo;
import com.fr.swift.cloud.query.post.FieldCalQuery;
import com.fr.swift.cloud.query.post.FunnelConversionRatePostQuery;
import com.fr.swift.cloud.query.post.FunnelTimeAvgPostQuery;
import com.fr.swift.cloud.query.post.FunnelTimeMedianPostQuery;
import com.fr.swift.cloud.query.post.HavingFilterQuery;
import com.fr.swift.cloud.query.post.RowSortQuery;
import com.fr.swift.cloud.query.post.TreeAggregationQuery;
import com.fr.swift.cloud.query.post.TreeFilterQuery;
import com.fr.swift.cloud.query.post.TreeSortQuery;
