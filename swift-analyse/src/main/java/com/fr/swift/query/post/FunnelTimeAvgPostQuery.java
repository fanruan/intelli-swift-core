 ...
 * @description
 */
public class FunnelTimeAvgPostQuery implements Query<QueryResultSet<FunnelResultSet>> {

    private int timeWindow;
    private Query<FunnelQueryResultSet> postQuery;

    public FunnelTimeAvgPostQuery(Query<FunnelQueryResultSet> postQuery, TimeWindowBean timeWindowBean) {
