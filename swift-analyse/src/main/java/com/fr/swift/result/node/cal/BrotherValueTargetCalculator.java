...
public class BrotherValueTargetCalculator extends AbstractBrotherTargetCalculator {
    public BrotherValueTargetCalculator(int[] paramIndex, int resultIndex, SwiftNode groupNode, List<Map<Integer, Object>> dic, Function<SwiftNode, AggregatorValueSet> aggFunc, List<Pair<Integer, GroupType>> brotherGroupIndex) {
