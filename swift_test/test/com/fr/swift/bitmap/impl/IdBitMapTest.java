...
public class IdBitMapTest extends TestCase {
    ...
    public void testGetAnd() {
        ...
        ImmutableBitMap im = IdBitMap.newInstance(id);
        ...
        if (tmp == 1 ? !and.contains(id) : and.contains(id)) {
            fail();
        }
    }
    ...
    public void testGetOr() {
        ...
        for (int i = 0; i < a.length; i++) {
            if (i != id) {
                if (a[i] == 1 ? !or.contains(i) : or.contains(i)) {
                    fail();
                }
            }
        }
    ...
    public void testGetAndNot() {
        ...
        if (m.contains(id) ? andNot.contains(id) : !andNot.contains(id)) {
            fail();
        }
    }
