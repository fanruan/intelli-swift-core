...
import com.fr.swift.generate.merge.MergeSegmentOperator;
...
public class RealtimeMergeTest extends BaseTest {
    ...
    @Test
    public void testMergeTransport() throws Exception {
        ...
        segmentList.get(1).getColumn(new ColumnKey("合同ID")).getDetailColumn().get(0);
