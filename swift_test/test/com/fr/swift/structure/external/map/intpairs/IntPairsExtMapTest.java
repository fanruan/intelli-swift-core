...
public class IntPairsExtMapTest extends TestCase {
    ...
    public void testIntPutThenGet() {
        ExternalMap<Integer, List<Pair<Integer, Integer>>> map =
                IntPairsExtMaps.newExternalMap(CLASS.INTEGER, Comparators.<Integer>asc(), "/externalMapTest/int");
        map.put(1, list1);
        map.put(0, list2);
        map.put(3, list3);
        map.dumpMap();
        ...
        Iterator<Map.Entry<Integer, List<Pair<Integer, Integer>>>> itr = map.getIterator();

        assertTrue(itr.hasNext());
        Map.Entry<Integer, List<Pair<Integer, Integer>>> entry = itr.next();
    ...
    public void testLongPutThenGet() {
        ExternalMap<Long, List<Pair<Integer, Integer>>> map =
                IntPairsExtMaps.newExternalMap(CLASS.LONG, Comparators.<Long>asc(), "/externalMapTest/long");
        map.put(1L, list1);
        map.put(0L, list2);
        map.put(3L, list3);
        map.dumpMap();
    ...
    public void testDoublePutThenGet() {
        ExternalMap<Double, List<Pair<Integer, Integer>>> map =
                IntPairsExtMaps.newExternalMap(CLASS.DOUBLE, Comparators.<Double>asc(), "/externalMapTest/double");
        map.put(1D, list1);
        map.put(0D, list2);
        map.put(3D, list3);
        map.dumpMap();
    ...
    public void testStringPutThenGet() {
        ExternalMap<String, List<Pair<Integer, Integer>>> map =
                IntPairsExtMaps.newExternalMap(CLASS.STRING, Comparators.<String>asc(), "/externalMapTest/String");
        map.put("1", list1);
        map.put("0", list2);
        map.put("3", list3);
        map.dumpMap();
