...
/**
 * {@link com.finebi.datasource.api.criteria.MapJoin#key} poses a number of implementation difficulties in terms of the
 * type signatures amongst the {@link com.finebi.datasource.api.criteria.Path}, {@link com.finebi.datasource.api.criteria.Join} and
...
public class MapKeyHelpers {
	...
	/**
	 * Models a path to a map key.  This is the actual return used from {@link com.finebi.datasource.api.criteria.MapJoin#key}
	 *
	...
	/**
	 * Defines an {@link com.finebi.datasource.api.metamodel.Attribute} modelling of a map-key.
	 *
	 * @param <K> The type of the map key
	 */
