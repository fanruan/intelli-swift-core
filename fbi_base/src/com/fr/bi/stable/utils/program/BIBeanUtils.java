...
public class BIBeanUtils {
     ...
     * @param clazz
     * @return
     * @throws BIFactoryKeyDuplicateException
     */
    public static ArrayList<Method> fetchSetterMethod(Class clazz) throws BIFactoryKeyDuplicateException {
        return filterMethodByParaAmount(fetchAttributeMethod(clazz, "set"), 1);
    }

    public static ArrayList<Method> fetchAttributeMethod(Class clazz, String prefix) throws BIFactoryKeyDuplicateException {
        ArrayList<Method> result = new ArrayList<Method>();
        if (clazz != null) {
            ...
            while (it.hasNext()) {
                ...
                if (nameMethod.containsKey(name.toLowerCase())) {
                    throw new BIFactoryKeyDuplicateException("Please check the Class:" + clazz.getName() + " and it's Method:" + method.getName() + ".\nThere" +
     ...
     * @throws BIFactoryKeyDuplicateException
     */
    public static ArrayList<Method> fetchGetterMethod(Class clazz) throws BIFactoryKeyDuplicateException {
