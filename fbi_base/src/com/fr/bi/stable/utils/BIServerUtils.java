...
public class BIServerUtils {
    ...
    public static long runServer(TableData data, ICubeFieldSource[] columns, Traversal<BIDataValue> back, String tableName) {
        DataModel dm = null;
        long rowCount = 0;
        try {
            long start = System.currentTimeMillis();
            dm = data.createDataModel(Calculator.createCalculator(), tableName);
