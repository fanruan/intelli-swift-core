...
public class DateUtils {
     ...
     * @return
     */
    public static boolean isCubeIntegerTimeGroup(int groupType) {

        return groupType == BIReportConstant.GROUP.Y
                || groupType == BIReportConstant.GROUP.M
                || groupType == BIReportConstant.GROUP.S
                || groupType == BIReportConstant.GROUP.W
                || groupType == BIReportConstant.GROUP.D
                || groupType == BIReportConstant.GROUP.WEEK_COUNT
                || groupType == BIReportConstant.GROUP.HOUR
                || groupType == BIReportConstant.GROUP.MINUTE
                || groupType == BIReportConstant.GROUP.SECOND;
    }

    public static boolean isCubeLongTimeGroup(int groupType) {
