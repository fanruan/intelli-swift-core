 ...
 * @since 4.0
 */
public class BIRelationPath<T, F, R extends BIBasicRelation<T, F>> extends BIListContainer<R> {
    public BIRelationPath() {
        super();
    }

    public BIRelationPath(R[] relations) throws BITablePathConfusionException {
        super();
    ...
    public BIRelationPath addRelationAtTail(R relation) throws BITablePathConfusionException {
    ...
    public BIRelationPath addRelationAtHead(R relation) throws BITablePathConfusionException {
        synchronized (container) {
            try {
    ...
    public void copyFrom(BIRelationPath path) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BITableRelationPath)) {
            return false;
        }

        BIRelationPath that = (BIRelationPath) o;
        Iterator<R> it = container.iterator();
