...
import com.fr.bi.stable.gvi.roaringbitmap.ArrayContainer;
import com.fr.bi.stable.gvi.roaringbitmap.Container;
import com.fr.bi.stable.gvi.roaringbitmap.IntConsumer;
import com.fr.bi.stable.gvi.roaringbitmap.PeekableShortIterator;
import com.fr.bi.stable.gvi.roaringbitmap.ShortIterator;
import com.fr.bi.stable.gvi.roaringbitmap.Util;
...
/**
 * Simple container made of an array of 16-bit integers. Unlike com.fr.bi.stable.gvi.roaringbitmap.ArrayContainer,
...
public final class MappeableArrayContainer extends MappeableContainer implements Cloneable {
  ...
  public MappeableArrayContainer and(final MappeableArrayContainer value2) {
    ...
    if (BufferUtil.isBackedBySimpleArray(this.content)
      ...
      answer.cardinality = com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedIntersect2by2(value1.content.array(),
  ...
  public MappeableArrayContainer andNot(final MappeableArrayContainer value2) {
    ...
    if (BufferUtil.isBackedBySimpleArray(value1.content)
        && BufferUtil.isBackedBySimpleArray(value2.content)) {
      answer.cardinality =
          com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedDifference(value1.content.array(), value1.getCardinality(),
  ...
  public MappeableArrayContainer iandNot(final MappeableArrayContainer value2) {
    ...
    if (BufferUtil.isBackedBySimpleArray(value2.content)) {
      this.cardinality =
          com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedDifference(this.content.array(), this.getCardinality(),
  ...
  public MappeableContainer or(final MappeableArrayContainer value2) {
    ...
    if (BufferUtil.isBackedBySimpleArray(value1.content)
        && BufferUtil.isBackedBySimpleArray(value2.content)) {
      answer.cardinality =
          com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedUnion2by2(value1.content.array(), value1.getCardinality(),
              value2.content.array(), value2.getCardinality(), answer.content.array());
    } else {
  ...
  public MappeableContainer xor(final MappeableArrayContainer value2) {
    ...
    if (BufferUtil.isBackedBySimpleArray(value1.content)
        && BufferUtil.isBackedBySimpleArray(value2.content)) {
      answer.cardinality = com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedExclusiveUnion2by2(value1.content.array(),
          value1.getCardinality(), value2.content.array(), value2.getCardinality(),
          answer.content.array());
    } else {
