...
import com.fr.bi.stable.gvi.roaringbitmap.RunContainer;
 ...
 * Uses a ShortBuffer to store data, unlike com.fr.bi.stable.gvi.roaringbitmap.RunContainer. Otherwise similar.
 * 
 * 
...
public final class MappeableRunContainer extends MappeableContainer implements Cloneable {
  ...
  public MappeableContainer andNot(MappeableArrayContainer x) {
    ...
    if (card <= MappeableArrayContainer.DEFAULT_MAX_SIZE) {
      ...
      ac.cardinality = com.fr.bi.stable.gvi.roaringbitmap.Util.unsignedDifference(this.getShortIterator(),
