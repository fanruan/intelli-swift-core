...
import com.fr.bi.stable.utils.algorithem.BIMathUtils;
...
public class IntMap<V> implements Iterable<IntMap.Entry<V>> {
    ...
    public IntMap (int initialCapacity, float loadFactor) {
        ...
        initialCapacity = BIMathUtils.nextPowerOfTwo((int)Math.ceil(initialCapacity / loadFactor));
    ...
    public void shrink (int maximumCapacity) {
        ...
        maximumCapacity = BIMathUtils.nextPowerOfTwo(maximumCapacity);
    ...
    public void ensureCapacity (int additionalCapacity) {
        ...
        if (sizeNeeded >= threshold) resize(BIMathUtils.nextPowerOfTwo((int)Math.ceil(sizeNeeded / loadFactor)));
    }
