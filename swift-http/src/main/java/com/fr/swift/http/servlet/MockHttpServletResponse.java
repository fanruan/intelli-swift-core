...
import com.fr.third.springframework.util.LinkedCaseInsensitiveMap;
...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    private final ServletOutputStream outputStream = new MockHttpServletResponse.ResponseServletOutputStream(this.content);
    ...
    public PrintWriter getWriter() throws UnsupportedEncodingException {
        ...
        if (this.writer == null) {
            ...
            this.writer = new MockHttpServletResponse.ResponsePrintWriter(targetWriter);
        }
        return this.writer;
    }
